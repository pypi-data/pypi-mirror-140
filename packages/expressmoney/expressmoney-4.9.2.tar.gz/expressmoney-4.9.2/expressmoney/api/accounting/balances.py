...
accounting_balances_a48801_balance_analytical = ServicePoint(SERVICE_NAME, 'balances', 'a48801_balance_analytical')
accounting_balances_a48802_balance_analytical = ServicePoint(SERVICE_NAME, 'balances', 'a48802_balance_analytical')
accounting_balances_p48809_balance_analytical = ServicePoint(SERVICE_NAME, 'balances', 'p48809_balance_analytical')


class A48801BalanceAnalyticalPoint(RetrievePointMixin, ContractObjectPoint):
    """Loan body balance"""
    _service_point = accounting_balances_a48801_balance_analytical
...
class A48802BalanceAnalyticalPoint(RetrievePointMixin, ContractObjectPoint):
    ...
    _service_point = accounting_balances_a48802_balance_analytical
...
class P48809BalanceAnalyticalPoint(RetrievePointMixin, ContractObjectPoint):
    """Interests paid"""
    _service_point = accounting_balances_p48809_balance_analytical
