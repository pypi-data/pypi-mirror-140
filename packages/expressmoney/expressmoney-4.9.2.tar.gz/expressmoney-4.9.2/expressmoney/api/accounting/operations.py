...
accounting_operations_loan_issue = ServicePoint(SERVICE_NAME, 'operations', 'loan_issue')
accounting_operations_loan_payment_body = ServicePoint(SERVICE_NAME, 'operations', 'loan_payment_body')
accounting_operations_loan_interests_charge = ServicePoint(SERVICE_NAME, 'operations', 'loan_interests_charge')
accounting_operations_loan_payment_interests = ServicePoint(SERVICE_NAME, 'operations', 'loan_payment_interests')


class LoanIssuePoint(CreatePointMixin, ContractPoint):
    """Issue loan body (Dt48801 Kt47422)"""
    _service_point = accounting_operations_loan_issue
...
class LoanInterestsChargePoint(CreatePointMixin, ContractPoint):
    ...
    _service_point = accounting_operations_loan_interests_charge
...
class LoanPaymentInterestsPoint(CreatePointMixin, ContractPoint):
    ...
    _service_point = accounting_operations_loan_payment_interests
