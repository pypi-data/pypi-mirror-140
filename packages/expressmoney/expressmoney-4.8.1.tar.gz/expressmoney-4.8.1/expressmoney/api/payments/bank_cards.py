...
payments_bank_cards_bank_card = ServicePoint(SERVICE_NAME, 'bank_cards', 'bank-card')


class BankCardPoint(ListMixin, CreateMixin, ContractPoint):
    _service_point = payments_bank_cards_bank_card
    _read_contract = BankCardContract
