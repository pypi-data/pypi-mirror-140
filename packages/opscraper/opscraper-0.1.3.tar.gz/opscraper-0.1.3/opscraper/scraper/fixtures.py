...
class Fixture:
    ...
    def parse_future_fixtures(self):
        ...
        fixture_logger.info(f"competitionId: {self.competition.competition_name},"
        f" message: extracting future games,"
        f" function: parse_future_fixtures")
    ...
    def extract_games_from_page(self, games_html):
        ...
        for single_game in games:
            ...
            logging.info(f"gameId: {oddsportal_game_id},"
                         ...
                         f" seasonId: {self.competition.season_id},"
                         f" message: extract game information,"
                         f" function: extract_games_from_page")
