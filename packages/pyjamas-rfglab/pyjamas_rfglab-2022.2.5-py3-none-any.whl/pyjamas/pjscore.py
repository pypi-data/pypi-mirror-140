...
class PyJAMAS(QtCore.QObject):
    ...
    processing_crop_size: int = 50  # crop size used for expensive operations (e.g. balloons)

    undo_stack_size: int = 500

    # Read version.
    __version__: str = '2022.2.5'
    ...
    def setupUI(self):
        ...
        self.addMenuItem(self.menuOptions, 'Set processing crop size ...', None,
