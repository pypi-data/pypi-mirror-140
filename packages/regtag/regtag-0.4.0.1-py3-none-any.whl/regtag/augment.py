...
def get_random_oov(value=None):
    global oov_dict
    global words_oov_dict
    if oov_dict is None:
        # oov_dict = dict({})
        with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'en_dict.json'), 'r',
                  encoding='utf-8') as file:
            oov_dict = json.load(file)
            words_oov_dict = list(oov_dict.keys())
            random.shuffle(words_oov_dict)

    # value = words_oov_dict[0]
    if value is None:
        value = words_oov_dict[random.choice(range(len(words_oov_dict)))]
        # value = words_oov_dict[random.choice(range(len(words_oov_dict)))]
...
def get_random_id():
    num_1 = get_random_decimal(0, 999, replace_zero=True, read_single=random.choice([True, False]))
    # num_2 = get_random_decimal(0, 9000, read_single=random.choice([True, True, False]))
    num_2 = get_random_decimal(min_num=100, max_num=5000, replace_zero=True,
                               read_single=random.choice([True, False]))
    ...
    candidates = [
        ...
        ("{}{}{}{}".format(char_1[0], sep_2[0], char_2[0], sep_1[0]),
         "{} {} {} {}".format(char_1[1], sep_2[1], char_2[1], sep_1[1])),
        ("{}{}{}{}".format(num_1[0], sep_1[0], char_1[0], sep_2[0]),
         "{} {} {} {}".format(num_1[1], sep_1[1], char_1[1], sep_2[1])),
        ("{}{}{}{}{}{}".format(num_1[0], sep_1[0], num_2[0], sep_2[0], char_1[0], sep_3[0]),
         "{} {} {} {} {} {}".format(num_1[1], sep_1[1], num_2[1], sep_2[1], char_1[1], sep_3[1])),
        ("{}{}{}{}".format(sep_1[0], num_2[0], sep_2[0], num_1[0]),
         "{} {} {} {}".format(sep_1[1], num_2[1], sep_2[1], num_1[1])),
        ("{}{}{}{}".format(sep_2[0], char_2[0], sep_1[0], num_1[0]),
         "{} {} {} {}".format(sep_2[1], char_2[1], sep_1[1], num_1[1])),
        ("{}{}{}{}".format(sep_1[0], char_1[0], sep_2[0], char_2[0]),
         "{} {} {} {}".format(sep_1[1], char_1[1], sep_2[1], char_2[1])),
    ]
...
def get_random_email():
    ...
    domain_name = get_random_oov()
    number = get_random_decimal(min_num=1, max_num=9999, read_single=True)
    sep = random.choice([
        ('_', 'xíp trừ'),
        ('_', 'gạch dưới'),
    ])

    website_name = random.choice(domain_name_dict)
    website_name_tgt = random.choice(website_name['tgt'])
    domain_name_1 = (website_name['src'], website_name_tgt)

    candidate = [
        ("{}@{}".format(domain_name[0], domain_extension[0]),
         '{} a còng {}'.format(domain_name[1], domain_extension[1]).strip()),

        ("{}{}@{}".format(domain_name[0], number[0], domain_extension[0]),
         '{} {} a còng {}'.format(domain_name[1], number[1], domain_extension[1]).strip()),

        ("{}{}{}@{}".format(domain_name[0], sep[0], number[0], domain_extension[0]),
         '{} {} {} a còng {}'.format(domain_name[1], sep[1], number[1], domain_extension[1]).strip()),

        ("{}@{}".format(domain_name_1[0], domain_extension[0]),
         '{} a còng {}'.format(domain_name_1[1], domain_extension[1]).strip()),

        ("{}{}@{}".format(domain_name_1[0], number[0], domain_extension[0]),
         '{} {} a còng {}'.format(domain_name_1[1], number[1], domain_extension[1]).strip()),

        ("{}{}{}@{}".format(domain_name_1[0], sep[0], number[0], domain_extension[0]),
         '{} {} {} a còng {}'.format(domain_name_1[1], sep[1], number[1], domain_extension[1]).strip()),
...
def get_random_scale(val=None):
    scale_dict = {"%": "phần trăm", "$": "đô la", "euro": random.choice(["êu rô", "ê rô", "ơ rô"]),
                  ...
                  "atm": random.choice(["áp mót phe", "át mót phe"]), "đ": "đồng", "ha": "héc ta", "giờ": "giờ",
                  "tháng": "tháng",
...
if __name__ == "__main__":
    ...
    for i in range(num_sample):
        ...
        # print(get_random_oov('school'))
        # print(get_random_domain())
        print(get_random_email())
        # get_random_span()
        # print(get_random_span())
    # print("Time: {}s".format((time.time() - start_time) / num_sample))
    # for i in range(1000):
