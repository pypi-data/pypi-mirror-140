...
from metanode.graphene_utils import (blip, from_iso_date, invert_pairs, it,
                                     jprint, precision, to_iso_date)
...
class RemoteProcedureCall:
    ...
    def operations(self):
        ...
        for create in creates:
            ...
            fee_amount = create["op"][1]["fee"]["amount"] / 10 ** int(
