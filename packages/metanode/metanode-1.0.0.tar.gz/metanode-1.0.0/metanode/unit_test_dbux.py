        ...
        while True:
            ...
            print(
                at(
                    (140, 3, 0, 0),
                    it("white", "1.3.0: ")
                    + two_tone(str(objects["1.3.0"]), "blue", "purple"),
                )
            )
            # ==========================================================================
            # BIDS; ASKS; HISTORY
            ...
            if pairs[pair]["book"]:
                ...
                for idx, item in enumerate(pairs[pair]["book"]["bids"][:3]):
                    print(
                        at((15, 39 + idx, 0, 0), two_tone(str(item), "blue", "purple"))
                    )
                # ======================================================================
                print(
                    at(
                ...
                for idx, item in enumerate(pairs[pair]["book"]["asks"][:3]):
                    print(
                        at((52, 39 + idx, 0, 0), two_tone(str(item), "purple", "blue"))
                    )
            # ==========================================================================
            ...
            # ==========================================================================
            print(
                at((140, 48, 0, 0), two_tone("0 CANCEL OPERATIONS", "yellow", "white"))
            )
            ...
            # ==========================================================================
            print(
                at((140, 55, 0, 0), two_tone("0 CREATE OPERATIONS", "yellow", "white"))
            )
            ...
            for idx, node in enumerate(nodesp):
                if node[-1] == "CONNECTED":
                    ...
                    print(
                        at((142, idx + 18, 0, 0), two_tone(str(node), "purple", "blue"))
                    )
                else:
                    print(
                        at((142, idx + 18, 0, 0), two_tone(str(node), "blue", "purple"))
                    )
            # ==========================================================================
            # BALANCES
            # ==========================================================================
            ...
            print(
                at(
                    (80, 6, 0, 0),
                    it("white", "PING:        ")
                    + two_tone(str(timing["ping"]), "yellow", "green"),
                )
            )
            print(
                at(
            ...
            print(
                at(
                    (80, 8, 0, 0),
                    it("white", "READ:        ")
                    + two_tone(str(timing["read"]), "yellow", "green"),
                )
            )
            # ==========================================================================
            # ACCOUNT
