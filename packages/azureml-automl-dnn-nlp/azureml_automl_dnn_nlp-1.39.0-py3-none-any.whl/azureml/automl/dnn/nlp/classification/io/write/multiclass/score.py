...
def init():
    ...
    global model
    model_dir = os.path.join(os.getenv(ScoringLiterals.AZUREML_MODEL_DIR_ENV), OutputLiterals.OUTPUT_DIR)
    model_path = os.path.join(model_dir, OutputLiterals.MODEL_FILE_NAME)
