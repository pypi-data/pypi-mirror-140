...
class OdbcDatabase(implements(DbInterface)):
    ...
    # API call
    def get_group_query_run_names(self, ws_id, job_id, group_by, agg_name, sort_col, first, last):
        '''
        ...
        sql_cmd += " inner join metrics on run_info._id = metrics._id where run_info.job_id = '{}' ".format(job_id)
