try:
    ...
    BaseWcs = astropy.wcs.wcsapi.BaseLowLevelWCS
except ImportError:
    BaseWcs = object
...
# Copied from https://docs.astropy.org/en/stable/_modules/astropy/wcs/wcsapi/low_level_api.html#BaseLowLevelWCS
# Conforms to https://doi.org/10.5281/zenodo.1188875
...
[docs]    @abc.abstractmethod
    ...
    def world_to_array_index_values(self, *world_arrays):
        ...
        array_indices = tuple(numpy.asarray(numpy.floor(pixel + 0.5), dtype=numpy.int_) for pixel in pixel_arrays)
