...
if "--disable-lto" in sys.argv:
    sys.argv.remove("--disable-lto")
else:
...
setuptools.setup(
    name="astrometry",
    version="0.0.1",
    url="http://20.0.0.1/astrosite/sessiontools",
    author="ICNS, Alexandre Marcireau, Nic Ralph",
    author_email="alexandre.marcireau@gmail.com",
    description="Post-process Astrosite sessions",
    long_description=long_description,
    long_description_content_type="text/markdown",
    install_requires=[],
    extras_require={"wcs": ["astropy>=5.0"]},
    classifiers=[
        ...
        setuptools.extension.Extension(
            ...
            sources=[
                ...
                *(
                    str(path.as_posix())
                    for path in (
                        pathlib.Path("astrometry.net") / "gsl-an" / "cblas"
                    ).iterdir()
                    if path.suffix == ".c"
                ),
                ...
                "astrometry.net/gsl-an/linalg/cholesky.c",
                ...
                "astrometry.net/gsl-an/sys/ldfrexp.c",
                ...
                "astrometry.net/libkd/kdtree_mem.c",
                # qfits
                "astrometry.net/qfits-an/anqfits.c",
                "astrometry.net/qfits-an/md5.c",
                ...
                "astrometry.net/qfits-an/qfits_image.c",
                "astrometry.net/qfits-an/qfits_md5.c",
