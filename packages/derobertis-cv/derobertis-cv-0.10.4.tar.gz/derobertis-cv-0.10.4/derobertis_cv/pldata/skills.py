...
SCALA_SKILL = SkillModel(
    "Scala", 4, parents=(PROGRAMMING_SKILL,), flexible_case=False, primary_category=PROGRAMMING_SKILL,
    experience=SkillExperiences([
...
KOTLIN_SKILL = SkillModel(
    "Kotlin", 3, parents=(PROGRAMMING_SKILL,), flexible_case=False, primary_category=PROGRAMMING_SKILL,
    experience=SkillExperiences([
...
_SKILLS: List[SkillModel] = [
    ...
    SkillModel(
        'GraphQL', 3, parents=BE_WEB_FRAMEWORK_SKILLS + FE_TS_WEB_FRAMEWORK_SKILLS, flexible_case=False,
