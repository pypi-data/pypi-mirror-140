...
class PatchGenerator(Streamer):
    ...
    @staticmethod
    def create(width: "int", height: "int", depth: "int"=1, level: "int"=0, overlapPercent: "float"=0.0, maskThreshold: "float"=0.5, paddingValue: "int"=-1) -> "std::shared_ptr< fast::PatchGenerator >":
        r"""
        ...
        :return: instance
        """
        return _fast.PatchGenerator_create(width, height, depth, level, overlapPercent, maskThreshold, paddingValue)
...
def PatchGenerator_create(width: "int", height: "int", depth: "int"=1, level: "int"=0, overlapPercent: "float"=0.0, maskThreshold: "float"=0.5, paddingValue: "int"=-1) -> "std::shared_ptr< fast::PatchGenerator >":
    r"""
    Creates a PatchGenerator instance
    :type width: int
    :param width: Width of patch (Note: patches can be smaller at boundaries)
...
class Interleave(Streamer):
    ...
    def connect(self, inputPortID: "uint", parentProcessObject: "std::shared_ptr< fast::ProcessObject >", outputPortID: "uint"=0) -> "std::shared_ptr< fast::Interleave >":
        return _fast.Interleave_connect(self, inputPortID, parentProcessObject, outputPortID)
...
class ImagePyramidAccess(object):
    ...
    def __init__(self, levels: "std::vector< fast::ImagePyramidLevel,std::allocator< fast::ImagePyramidLevel > >", fileHandle: "openslide_t *", tiffHandle: "TIFF *", stream: "std::ifstream *", vsiTiles: "std::vector< fast::vsi_tile_header,std::allocator< fast::vsi_tile_header > > &", imagePyramid: "std::shared_ptr< fast::ImagePyramid >", writeAccess: "bool", initializedPatchList: "std::unordered_set< std::string > &"):
        _fast.ImagePyramidAccess_swiginit(self, _fast.new_ImagePyramidAccess(levels, fileHandle, tiffHandle, stream, vsiTiles, imagePyramid, writeAccess, initializedPatchList))
...
class TensorShape(object):
    ...
    def __init__(self, dimensions: "vectori"):
        r"""
        Construct tensor shape
        :type dimensions: std::vector< int,std::allocator< int > >
        :param dimensions:
        """
        _fast.TensorShape_swiginit(self, _fast.new_TensorShape(dimensions))
