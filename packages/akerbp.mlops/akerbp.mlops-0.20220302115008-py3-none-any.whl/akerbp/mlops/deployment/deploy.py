...
def deploy_model(model_settings, platform_methods=platform_methods):
    ...
    try:            
        ...
        if c.platform == "cdf": # For now this will always be the case. #TODO:  
            ...
            if len(artifact_versions) == 0:
                return f"Model {human_readable_function_name} failed to deploy to {env} because no artifacts were found. Please upload/promote artifacts or specify a correct model name and redeploy"
