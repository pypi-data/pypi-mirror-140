...
def create_function_from_folder(
    ...
    Inputs:
      - human_readable_name: name of function to create
      - function_name: external id of function to create
    ...
    try:
        client.functions.delete(external_id=function_name)
        logging.debug(f"Deleted function {human_readable_name} with external id {function_name}")
    except CogniteNotFoundError:
        pass
