...
class Paths12Z2UukModuleV10SubscriptionsSubscriptionidResourcegroupsResourcegroupnameProvidersMicrosoftMachinelearningservicesWorkspacesWorkspacenamePostRequestbodyContentMultipartFormDataSchema(msrest.serialization.Model):
    ...
    :ivar snapshot_source_zip_file: abcd.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword snapshot_source_zip_file: abcd.
...
class RunConfiguration(msrest.serialization.Model):
    ...
    :ivar framework: Possible values include: "Python", "PySpark", "Cntk", "TensorFlow", "PyTorch",
     "TensorFlowParameterServer", "PythonMpi", "PythonIntelMpi", "PySparkInteractive", "R".
    :vartype framework: str or ~designer.models.Framework
    :ivar communicator: Possible values include: "None", "ParameterServer", "OpenMpi", "IntelMpi",
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword framework: Possible values include: "Python", "PySpark", "Cntk", "TensorFlow",
         "PyTorch", "TensorFlowParameterServer", "PythonMpi", "PythonIntelMpi", "PySparkInteractive",
         "R".
        :paramtype framework: str or ~designer.models.Framework
        :keyword communicator: Possible values include: "None", "ParameterServer", "OpenMpi",
         "IntelMpi", "Gloo", "Mpi", "Nccl", "ParallelTask".
