...
class DesignerServiceCaller(WorkspaceTelemetryMixin, RequestTelemetryMixin):
    ...
    def list_samples(self):
        ...
        resp_body = json.loads(result.http_request.http_response.internal_response.content)
    ...
    def get_pipeline_run_status(
            self, pipeline_run_id, experiment_name=None, experiment_id=None, cls=None, enum_to_str=False):
    ...
    def _get_pipeline_component_graph(self, graph_id, fetch_nested_graphs=False, skip_dataset_load=True,
                                      referenced_node_id=None, cls=None, enum_to_str=False):
