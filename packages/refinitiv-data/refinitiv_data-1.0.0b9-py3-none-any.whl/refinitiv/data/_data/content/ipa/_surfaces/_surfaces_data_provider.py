...
from refinitiv.data._data.delivery.data._data_provider import Parser
...
class SurfacesParser(Parser):
    def process_failed_response(self, raw_response):
        ...
        ... {
        ...     "error": {
        ...         "id": "edb96b6d-b175-423b-8391-025cdcb17ba8",
        ...         "code": "400",
        ...         "message": "Validation error",
        ...         "status": "Bad Request",
        ...         "errors": [
        ...             {
        ...                 "key": "volatilitySurfaceRequest",
        ...                 "reason": 'volatilitySurfaceRequest.universe.surfaceLayout in body must be of type object: "string"',
        ...             }
        ...         ],
        ...     }
        ... }
