...
class Definition(ContentProviderLayer):
    ...
    >>> definition = estimates.view_summary.historical_snapshots_periodic_measures_interim.Definition(universe="IBM.N", package=estimates.Package.BASIC, use_field_names_in_headers=True)
