...
@LastEditTime: 2022-02-16 19:08:42
    ...
    def get_async(self):
        ...
        if send_num > 0:
            ...
            if currency_type == 1:
                ...
                if invoke_result_data.success == False:
                    return self.reponse_json_error("Error", "无法操作会员积分")
                send_result = self.send_lottery_value(log_title, user_info, "", send_num, act_dict, 2, 204, currency_type)
            if send_result == False:
    ...
    def get_async(self):
        ...
        if send_num > 0:
            ...
            if currency_type == 1:
                ...
                if invoke_result_data.success == False:
                    return self.reponse_json_error("Error", "无法操作会员积分")
                send_result = self.send_lottery_value(log_title, user_info, "", send_num, act_dict, 2, 205, currency_type)
            if send_result == False:
