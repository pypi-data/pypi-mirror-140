...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, connect_timeout=None, sock_connect_timeout=None, username=None, name=None, total_timeout=None, rate_limit=None, pulp_labels=None, max_retries=None, download_concurrency=None, proxy_username=None, proxy_url=None, proxy_password=None, client_key=None, url=None, password=None, ca_cert=None, headers=None, tls_validation=None, sock_read_timeout=None, client_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
