...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, total_timeout=None, headers=None, pulp_href=None, proxy_url=None, pulp_created=None, url=None, ca_cert=None, sock_connect_timeout=None, pulp_last_updated=None, tls_validation=None, connect_timeout=None, name=None, max_retries=None, download_concurrency=None, sock_read_timeout=None, pulp_labels=None, rate_limit=None, client_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
