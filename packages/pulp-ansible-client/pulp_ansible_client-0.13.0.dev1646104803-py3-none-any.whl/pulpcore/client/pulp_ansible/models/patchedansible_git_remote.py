...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, proxy_username=None, total_timeout=None, headers=None, proxy_url=None, proxy_password=None, url=None, password=None, ca_cert=None, sock_connect_timeout=None, client_key=None, tls_validation=None, connect_timeout=None, username=None, name=None, max_retries=None, download_concurrency=None, sock_read_timeout=None, pulp_labels=None, rate_limit=None, client_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
