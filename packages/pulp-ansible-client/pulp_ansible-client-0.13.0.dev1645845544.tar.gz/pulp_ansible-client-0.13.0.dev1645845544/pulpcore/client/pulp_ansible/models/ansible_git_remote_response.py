...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, connect_timeout=None, sock_connect_timeout=None, name=None, total_timeout=None, pulp_last_updated=None, rate_limit=None, pulp_labels=None, pulp_created=None, max_retries=None, download_concurrency=None, proxy_url=None, pulp_href=None, url=None, ca_cert=None, headers=None, tls_validation=None, sock_read_timeout=None, client_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
