...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=URiAN
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:URiAB)->URiAB:
  pass
 @URiAn
 def get(cls,requested_file_locator:URiAB):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=URiAN
 @URiAn
 def get(cls,state_file_locator:URiAB,requested_storage:URiAB,serializers:Dict[URiAB,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[URiAB,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:URiAB)->URiAB:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:URiAB)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:URiAB)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:URiAB)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:URiAB)->URiAB:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[URiAB]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:URiAB,new_key:URiAB,referenced_by_version:URiAB=URiAN):
  pass
 @abc.abstractmethod
 def version_exists(self,key:URiAB)->URiAe:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:URiAB,key:URiAB):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:URiAB,new_key:URiAB,base_path:URiAB)->URiAe:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[URiAB]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[URiAB,URiAB],remote_location:URiAB=URiAN)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[URiAB]:
  ...
  for cpvcs_obj in args:
   if URiAr(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif URiAr(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[URiAB,URiAB],remote_location:URiAB=URiAN)->List[Union[Revision,Version]]:
