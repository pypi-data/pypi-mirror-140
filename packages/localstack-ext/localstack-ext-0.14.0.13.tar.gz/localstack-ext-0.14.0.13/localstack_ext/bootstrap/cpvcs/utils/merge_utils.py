...
class CPVCSMergeManager(SubtypesInstanceManager):
 @ICuJv
 def _is_special_case(obj)->ICuJY:
  return ICuJW(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:ICuJf,to_state_files):
  raise ICuJO("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:ICuJf,from_state_files:ICuJf,to_state_files:ICuJf):
  raise ICuJO("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:ICuJf)->Dict[ICuJf,ICuJf]:
