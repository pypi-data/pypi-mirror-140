...
class CPVCSMergeManager(SubtypesInstanceManager):
 @tdDQH
 def _is_special_case(obj)->tdDQx:
  return tdDQU(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:tdDQE,to_state_files):
  raise tdDQO("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:tdDQE,from_state_files:tdDQE,to_state_files:tdDQE):
  raise tdDQO("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:tdDQE)->Dict[tdDQE,tdDQE]:
