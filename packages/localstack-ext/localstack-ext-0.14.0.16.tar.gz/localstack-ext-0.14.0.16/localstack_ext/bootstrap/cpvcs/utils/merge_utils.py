...
class CPVCSMergeManager(SubtypesInstanceManager):
 @xeyVi
 def _is_special_case(obj)->xeyVX:
  return xeyVE(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:xeyVP,to_state_files):
  raise xeyVg("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:xeyVP,from_state_files:xeyVP,to_state_files:xeyVP):
  raise xeyVg("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:xeyVP)->Dict[xeyVP,xeyVP]:
