...
class CPVCSConfigContext:
 ...
 def get_version_state_archive_path(self,version,with_format:gvzNx=gvzNF)->gvzNu:
 ...
 def update_ver_log(self,author:gvzNu,ver_no:gvzNi,rev_id:gvzNu,rev_no:gvzNi):
  with gvzNs(self.get_ver_log_path(),"a")as fp:
   fp.write(f"{VER_LOG_STRUCTURE.format(author=author, ver_no=ver_no, rev_rid_no=f'{rev_id}_{rev_no}')}\n")
 def create_version_symlink(self,name:gvzNu,key:gvzNu=gvzNm)->gvzNu:
  return self._create_symlink(name,key,self.get_ver_refs_path())
 def create_revision_symlink(self,name:gvzNu,key:gvzNu=gvzNm)->gvzNu:
  return self._create_symlink(name,key,self.get_rev_refs_path())
 def is_initialized(self)->gvzNx:
  return self.pod_root_dir and os.path.isdir(self.pod_root_dir)
 def _create_symlink(self,name:gvzNu,key:gvzNu,path:gvzNu)->gvzNu:
...
def zip_directories(zip_dest:gvzNu,directories:List[gvzNu])->gvzNu:
 ...
 return zip_dest
def add_file_to_archive(archive:gvzNu,entry_name:gvzNu,content:Union[gvzNu,gvzNJ]):
 with zipfile.ZipFile(archive,"a")as zip_file:
  zip_file.writestr(entry_name,content)
def read_file_from_archive(archive_path:gvzNu,file_name:gvzNu)->gvzNu:
 try:
