...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=YtyRU
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:YtyRw)->YtyRw:
  pass
 @YtyRg
 def get(cls,requested_file_locator:YtyRw):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=YtyRU
 @YtyRg
 def get(cls,state_file_locator:YtyRw,requested_storage:YtyRw,serializers:Dict[YtyRw,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[YtyRw,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:YtyRw)->YtyRw:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:YtyRw)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:YtyRw)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:YtyRw)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:YtyRw)->YtyRw:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[YtyRw]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:YtyRw,new_key:YtyRw,referenced_by_version:YtyRw=YtyRU):
  pass
 @abc.abstractmethod
 def version_exists(self,key:YtyRw)->YtyRj:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:YtyRw,key:YtyRw):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:YtyRw,new_key:YtyRw,base_path:YtyRw)->YtyRj:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[YtyRw]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[YtyRw,YtyRw],remote_location:YtyRw=YtyRU)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[YtyRw]:
  ...
  for cpvcs_obj in args:
   if YtyRp(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif YtyRp(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[YtyRw,YtyRw],remote_location:YtyRw=YtyRU)->List[Union[Revision,Version]]:
