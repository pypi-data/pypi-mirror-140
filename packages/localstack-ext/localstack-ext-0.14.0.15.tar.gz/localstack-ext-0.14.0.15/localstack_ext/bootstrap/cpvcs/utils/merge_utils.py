...
class CPVCSMergeManager(SubtypesInstanceManager):
 @HIwDx
 def _is_special_case(obj)->HIwDz:
  return HIwDs(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:HIwDS,to_state_files):
  raise HIwDl("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:HIwDS,from_state_files:HIwDS,to_state_files:HIwDS):
  raise HIwDl("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:HIwDS)->Dict[HIwDS,HIwDS]:
