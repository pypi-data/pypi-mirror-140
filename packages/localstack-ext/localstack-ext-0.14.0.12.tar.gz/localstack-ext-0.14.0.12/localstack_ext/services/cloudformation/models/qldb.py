...
class QLDBLedger(GenericBaseModel):
 ...
 def get_physical_resource_id(self,attribute=TGzsH,**kwargs):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  return result
 @TGzsL
 def add_defaults(resource:Dict,stack_name:TGzsw):
 ...
 def get_deploy_templates():
  def _delete_ledger(resource_id,resources,*args,**kwargs):
   ...
   qldb.update_ledger(Name=ledger_name,DeletionProtection=TGzsS)
