...
class ThinkDataQuery(object):
    ...
    def get_data_csv(self, ctx, sql, block_size=100000, print_size=100000, read_timeout=600):
        """
    ...
    def get_data_raw_pyhive(self, ctx, sql, block_size=100000, fetch_size=10000, retry_count=5, read_timeout=300, upcount=None, print_size=100000):
        '''
