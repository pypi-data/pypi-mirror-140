...
class ThinkDataQuery(object):
    ...
    def get_data_raw_pyhive(self, ctx, sql, block_size=100000, fetch_size=10000, retry_count=5, read_timeout=60, upcount=None):
        '''
    ...
    def get_data_raw_pyhive_i(self, ctx, unique_path, sql, block_size=100000, fetch_size=10000, read_timeout=60, upcount=None):
        '''
        @des: 内部调用
        '''
