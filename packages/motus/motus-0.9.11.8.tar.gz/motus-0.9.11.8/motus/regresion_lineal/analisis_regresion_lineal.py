...
class ProcesamientoRegresionLineal:
    ...
    def agrega_categoria_regresion_lineal(self,
        ...
        print("Agrego categoria de regresion_lineal")
        print("--------------------------------------------------------------")
        print("Diccionario general:", diccionario_regresiones_lineales)
        print("Nombre a asignar:", nombre_tipo_regresion_lineal)
        ...
        print("Nuevo diccionario: ", diccionario_regresiones_lineales)
