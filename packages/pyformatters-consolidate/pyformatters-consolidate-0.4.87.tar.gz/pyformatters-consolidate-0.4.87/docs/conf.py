...
import pyformatters_consolidate


# -- Project information -----------------------------------------------------

project = "pyformatters_consolidate"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyformatters_consolidate.__version__
release = pyformatters_consolidate.__version__
...
apidoc_module_dir = os.path.dirname(pyformatters_consolidate.__file__)
