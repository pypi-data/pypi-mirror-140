...
from infinstor import run_utils
...
def infin_declare_input(mountpath, name=None):
    ...
    mounted_paths_list.append(updated_mount_point)
...
def infin_log_output(output_dir):
    ...
    if mlflow.active_run():
        run_utils.log_all_artifacts_in_dir(None, None, output_dir, delete_output=False)
    else:
        print('No active run')
