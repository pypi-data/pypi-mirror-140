...
class FileTree:
    ...
    def add_subtree(self, sub_tree: "FileTree", precursor: Union[Optional[str], Sequence[Optional[str]]]=(None, ), parent: Optional[str]="") -> None:
    ...
    def _generate_rich_report(self, template: Template=None):
        """
