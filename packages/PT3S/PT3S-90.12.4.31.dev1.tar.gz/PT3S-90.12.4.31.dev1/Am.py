...
class Am():
    ...
    def MxAdd(self,mx):
        """
        Adds Results from mx to V3_KNOT, V3_ROHR, V3_FWVB
        """
        ...
        try:         
            ...
            for dfName,resType in zip(['V3_KNOT','V3_ROHR','V3_FWVB'],['^KNOT','^ROHR','^FWVB']):
                ...
                self.dataFrames[dfName]=df.merge(dfRes,left_on='pk',right_index=True,how='left')
    ...
    def ShpAdd(self,shapeFile,crs='EPSG:25832',onlyObjectsInContainerLst=['M-1-0-1']):
        """
        ...
        auch wenn SIR 3S ab N zukuenftig nativ eine Geometriespalte haelt, kann es sinnvoll sein fuer bestimmte Darstellungszwecke Geometrien (zu generieren) und hier zuzuordnen 
