...
# print("------------------------------------------------------------")
# print("Program Execution Started, Program by: Deepak Raj 101903277 3COE11")
...
def main():
    ...
    if len(sys.argv) != 5:
        ...
        # print("Usage: python 101903277.py 101903277-data.csv \"Weights\" \"Impacts\" 101903277-result-1/2.csv")
        exit(0)
