...
def extract_documents(xml_string):
    ...
    docusign_data_dict = json.loads(line)
    documents = []
    for document_pdf in docusign_data_dict["DocumentPDFs"]["DocumentPDF"]:
        document={}
            ...
            if recipient_auth_status is not None:
                ...
                if current_status is None:
                    ...
                    for recipient in recipient_status:
                        ...
                        if recipient["email"] == recipient_data["email"] and recipient["name"] == recipient_data["name"] and recipient["custom_fields"]["CustomField"] in custom_fields["CustomField"]:
