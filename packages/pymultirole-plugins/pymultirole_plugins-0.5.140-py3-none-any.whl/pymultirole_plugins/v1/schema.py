...
class Annotation(Span):
    ...
    createdBy: Optional[str] = Field(None, description="Name of the user or the process that created the annotation")
...
class Category(BaseModel):
    ...
    createdBy: Optional[str] = Field(None, description="Name of the user or the process that created the category")
    createdDate: Optional[str] = Field(None, description="Creation date")
    modifiedDate: Optional[str] = Field(None, description="Last modification date")
...
class Document(BaseModel):
    ...
    boundaries: Optional[Dict[Optional[str], List[Boundary]]] = Field(None, description="List of boundaries by type")
