        ...
        for laneImpact in laneImpacts:
            ...
            for laneImpact2 in new_message['properties']['laneImpacts']:
                if direction_string == laneImpact2['direction']:
                    ...
                    new_message['properties']['recorded_direction'] = message['properties']['direction']
...
def create_rtdh_standard_msg(pd):
    ...
    print(direction, map_direction_string(
        pd.get("properties/recorded_direction")))
    recorded_direction = map_direction_string(pd.get("properties/recorded_direction"))
