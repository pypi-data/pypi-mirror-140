...
import requests
from notecoin.okex.common import exceptions
from notecoin.okex.v5 import consts as c
from notecoin.okex.v5 import utils


class BaseClient(object):

    def __init__(self, api_key, api_secret_key, passphrase, use_server_time=False, test=False, first=False, api_url=None):
        ...
        self.first = first
        self.test = test
        self.api_url = api_url or c.API_URL
        self.proxy = None
