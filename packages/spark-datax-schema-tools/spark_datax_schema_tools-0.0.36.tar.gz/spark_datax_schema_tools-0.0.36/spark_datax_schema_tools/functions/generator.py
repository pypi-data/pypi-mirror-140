...
def generate_dictionary(spark=None,
    ...
    df_fields_global["EXISTE_EN_REPO_CENTRAL"] = df_fields_global.apply(lambda x: apply_comparate_sofia_datum(x["EXISTE_EN_REPO_CENTRAL"], x["NEW_EXISTE_EN_REPO_CENTRAL"]), axis=1)
    df_fields_global["PHYSICAL_NAME_FIELD"] = df_fields_global.apply(lambda x: apply_comparate_sofia_datum(x["PHYSICAL_NAME_FIELD"], x["PHYSICAL_NAME_FIELD"]), axis=1)
    df_fields_global["LOGICAL_NAME_FIELD_SPA"] = df_fields_global.apply(lambda x: apply_comparate_sofia_datum(x["NEW_LOGICAL_NAME_FIELD_SPA"], x["LOGICAL_NAME_FIELD_SPA"]), axis=1)
    ...
    df_fields_global["TOKENIZED_AT_DATA_SOURCE"] = df_fields_global.apply(lambda x: apply_comparate_sofia_datum(x["TOKENIZED_AT_DATA_SOURCE"], x["NEW_TOKENIZED_AT_DATA_SOURCE"]), axis=1)
