...
class Aadhar_Info_Extractor:
    ...
    def info_extractor(self, front_image):
        ...
        # except NameError:
        #     to_unicode = str
        # with io.open('aadhar.json', 'w', encoding='utf-8') as outfile:
        #     # print(data)
        #     data = json.dumps(self.extracted, indent=4, sort_keys=True, separators=(',', ': '), ensure_ascii=False)
...
if __name__ == '__main__':
    ...
    print(ext.info_extractor('front.jpg'))