...
def get_allocation_stats():
    ffcs__rzy = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    jsd__jlih, zlr__jqksf, dwazt__kaf, mpzzf__mlr = 0, 0, 0, 0
    for kbwjf__fda in ffcs__rzy:
        jsd__jlih += kbwjf__fda[0]
        zlr__jqksf += kbwjf__fda[1]
        dwazt__kaf += kbwjf__fda[2]
        mpzzf__mlr += kbwjf__fda[3]
    return jsd__jlih, zlr__jqksf, dwazt__kaf, mpzzf__mlr
