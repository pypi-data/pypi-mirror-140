...
def get_allocation_stats():
    aczi__nzr = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    kxm__ilga, kez__npapz, ewod__isvpz, fexm__urwg = 0, 0, 0, 0
    for ppy__dfhu in aczi__nzr:
        kxm__ilga += ppy__dfhu[0]
        kez__npapz += ppy__dfhu[1]
        ewod__isvpz += ppy__dfhu[2]
        fexm__urwg += ppy__dfhu[3]
    return kxm__ilga, kez__npapz, ewod__isvpz, fexm__urwg
