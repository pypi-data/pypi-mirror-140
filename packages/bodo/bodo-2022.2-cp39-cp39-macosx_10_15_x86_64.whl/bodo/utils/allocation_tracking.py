...
def get_allocation_stats():
    xdbq__whut = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    vvtcp__hwdpw, rnkoz__efwnf, pgvx__ckldx, eetb__mubo = 0, 0, 0, 0
    for nkx__vej in xdbq__whut:
        vvtcp__hwdpw += nkx__vej[0]
        rnkoz__efwnf += nkx__vej[1]
        pgvx__ckldx += nkx__vej[2]
        eetb__mubo += nkx__vej[3]
    return vvtcp__hwdpw, rnkoz__efwnf, pgvx__ckldx, eetb__mubo
