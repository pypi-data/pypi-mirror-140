...
async def present(
    ...
    **Autogenerated function**
    ...
    if before:
        result[
            "old_state"
        ] = hub.tool.aws.iam.utils.convert_raw_instance_profile_to_present(before)
        result["new_state"] = copy.deepcopy(before)
        result["comment"] = f"'{name}' already exists"
        # Update key tags if tags are specified
        if tags is not None and tags != before.get("Tags", []):
    ...
    if before and update_ret is None:
        ...
        result[
            "new_state"
        ] = hub.tool.aws.iam.utils.convert_raw_instance_profile_to_present(after)
...
async def describe(hub, ctx) -> Dict[str, Dict[str, Any]]:
    ...
    **Autogenerated function**
    ...
    for instance_profile in ret["ret"]["InstanceProfiles"]:
        ...
        translated_resource = (
            hub.tool.aws.iam.utils.convert_raw_instance_profile_to_present(resource)
        )
