    ...
    **Autogenerated function**
    ...
    if before:
        try:
            result[
                "old_state"
            ] = await hub.tool.aws.iam.utils.convert_raw_policy_to_present(ctx, before)
            ...
            if (
                ...
                update_ret = await hub.exec.aws.iam.policy.update_policy(
                    ctx=ctx,
                    policy_arn=result["old_state"].get("arn"),
            ...
            if (
                ...
                and tags != result["old_state"].get("tags", None)
            ):
                update_ret = await hub.exec.aws.iam.policy.update_policy_tags(
                    ctx=ctx,
                    police_arn=result["old_state"].get("arn"),
    ...
    try:
        if before and update_ret is None:
            ...
            result[
                "new_state"
            ] = await hub.tool.aws.iam.utils.convert_raw_policy_to_present(ctx, after)
    ...
    **Autogenerated function**
    ...
    if not before:
        ...
        try:
            result[
                "old_state"
            ] = await hub.tool.aws.iam.utils.convert_raw_policy_to_present(
...
async def describe(hub, ctx) -> Dict[str, Dict[str, Any]]:
    ...
    **Autogenerated function**
    ...
    for policy in ret_policies["ret"]["Policies"]:
        translated_resource = (
            await hub.tool.aws.iam.utils.convert_raw_policy_to_present(ctx, policy)
        )
