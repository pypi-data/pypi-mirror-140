...
class CoordinatorService final {
 public:
  ...
  typedef WithStreamedUnaryMethod_ConnectSession<WithStreamedUnaryMethod_HeartBeat<WithStreamedUnaryMethod_CloseSession<Service > > > StreamedUnaryService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_ConnectSession<WithStreamedUnaryMethod_HeartBeat<WithSplitStreamingMethod_FetchLogs<WithStreamedUnaryMethod_CloseSession<Service > > > > StreamedService;
};
