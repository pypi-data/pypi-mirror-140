...
name = "topsis_shreya/topsis_shreya"
__version__ = "1.0.4"
__author__ = 'Shreya Jha'
__credits__ = 'TIET'
...
def main():
    ...
    # File extension not csv
        ...
        print(f"ERROR : {sys.argv[1]} is not a csv file !!")
        exit(1)
        ...
        if nCol < 3:
            print("ERROR : Input file has less then 3 columns int it")
            exit(1)
        ...
        try:
            ...
            print("ERROR : please check weights array again")
            exit(1)
        impact = sys.argv[3].split(',')
        for i in impact:
            if not (i == '+' or i == '-'):
                print("ERROR : please chcek impact array again")
                exit(1)
