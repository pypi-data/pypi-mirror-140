...
def __tasks_to_excel_tasks(log, wb, tasks_dict, sheet_tasks, date_offset, horizon_granularity):
    ws = wb.active
...
def tasks_to_excel(
    ...
    __tasks_to_excel_tasks(log, wb, tasks_dict, sheet_tasks, date_offset, horizon_granularity)
