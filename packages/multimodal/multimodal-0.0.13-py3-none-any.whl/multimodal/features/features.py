...
from multimodal.features import COCOBottomUpFeatures, GQAVGFeatures
...
def get_features(name, split, dir_data, args={}):
    ...
    if name == "coco-bottomup":
        ...
        features = GQAVGFeatures(dir_data=dir_data, features="objects")
    elif name == "gqa-vg-grid":
        features = GQAVGFeatures(dir_data=dir_data, features="spatial")
