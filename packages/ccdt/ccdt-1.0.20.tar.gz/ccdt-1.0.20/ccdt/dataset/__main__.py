...
def before_print(datasets):
    ...
    for dataset in datasets:
        ...
        print(dataset)
        tb = pt.PrettyTable()
        tb.field_names = ['label_name', 'flags_name', 'shape_type_name']
        for key, value in dataset.label_shape_flags.items():
            # print(key)
            # print(value)
            tb.add_row([key, value['shape_type'], value['flags']])
        # row = pt.PrettyTable()
        ...
        # tb.add_column(column_names[0], dataset.label_shape_flags.keys())
