...
With this package installed and also brainreg installed you can run registrations with super easily at the command line:
...
Running `brainregbt -D` will run the registration with the above defaults
