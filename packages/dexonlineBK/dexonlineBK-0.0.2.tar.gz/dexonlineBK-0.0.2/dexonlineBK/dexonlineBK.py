...
"""
def getSpans(link=None, tag=None, clas=None):
...
def getParadigms(word=None):
	...
	uls = getSpans(link, 'ul', 'commaList')
...
def reallyExist(word=None):
	lex = loc_flexiuni_6_0.loc_flexiuni_6_0
	return True if str(word) in lex else False