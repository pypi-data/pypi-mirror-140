...
from Juwel import GUI_element_finder
...
class Text_parser:
    ...
    def read_template(self):
        ...
        try:
            ...
            final_list = [{"GUI_type": "checkbox", "key": "Please select a configuration file (Menu -> Load configuration).", "default": "rot", "values": [], "newline": "no"}]
            return final_list
