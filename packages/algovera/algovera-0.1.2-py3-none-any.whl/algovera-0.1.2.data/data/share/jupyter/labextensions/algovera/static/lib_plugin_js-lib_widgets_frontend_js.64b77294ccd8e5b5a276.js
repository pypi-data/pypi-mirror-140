"use strict";
(self["webpackChunkalgovera"] = self["webpackChunkalgovera"] || []).push([["lib_plugin_js-lib_widgets_frontend_js"],{
...
/* harmony import */ var _widget__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./widget */ "./lib/widgets/frontend.js");
/* harmony import */ var _widget__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./widget */ "./lib/widgets/shell.js");
/* harmony import */ var _widget__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./widget */ "./lib/widgets/commands.js");
/* harmony import */ var _widget__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./widget */ "./lib/widgets/palette.js");
/* harmony import */ var _widget__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./widget */ "./lib/widgets/sessions.js");
/* harmony import */ var _widget__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./widget */ "./lib/widget.js");
/* harmony import */ var _version__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./version */ "./lib/version.js");
...
/* harmony import */ var _widgets_panel1__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./widgets/panel1 */ "./lib/widgets/panel1.js");
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ethers */ "webpack/sharing/consume/default/ethers/ethers");
...
/* harmony import */ var _widgets_address__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./widgets/address */ "./lib/widgets/address.js");
/* harmony import */ var _widgets_transaction__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./widgets/transaction */ "./lib/widgets/transaction.js");
...
const [privateKey, walletAddress] = (0,_widgets_address__WEBPACK_IMPORTED_MODULE_7__["default"])();
...
function activate(app, palette, rendermime, translator, registry, launcher, labShell) {
    ...
    _widget__WEBPACK_IMPORTED_MODULE_10__.CommandRegistryModel.commands = app.commands;
    _widget__WEBPACK_IMPORTED_MODULE_11__.CommandPaletteModel.palette = palette;
    _widget__WEBPACK_IMPORTED_MODULE_12__.SessionManagerModel.sessions = app.serviceManager.sessions;
    _widget__WEBPACK_IMPORTED_MODULE_12__.SessionManagerModel.shell = app.shell;
    _widget__WEBPACK_IMPORTED_MODULE_12__.SessionManagerModel.labShell = labShell;
    ...
    async function createPanel() {
        panel = new _widgets_panel1__WEBPACK_IMPORTED_MODULE_15__.ExamplePanel(manager, rendermime, translator);
    ...
    commands.addCommand(command2, {
        ...
        caption: "send ocean",
        execute: (args) => {
            (0,_widgets_transaction__WEBPACK_IMPORTED_MODULE_16__["default"])(walletAddress);
        },
    });
...
async function getAccount() {
    const provider = new ethers__WEBPACK_IMPORTED_MODULE_6__.providers.Web3Provider(window.ethereum, "any");
...
const extension = {
    ...
    optional: [_jupyterlab_launcher__WEBPACK_IMPORTED_MODULE_3__.ILauncher, _jupyterlab_application__WEBPACK_IMPORTED_MODULE_0__.ILabShell],
    activate: activate,
};
...
class JupyterFrontEndModel extends _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_0__.WidgetModel {
    ...
    initialize(attributes, options) {
        ...
        super.initialize(attributes, options);
        this.send({ event: `lab_ready-${_plugin__WEBPACK_IMPORTED_MODULE_1__.privateKey}` }, {});
...
JupyterFrontEndModel.model_module = _version__WEBPACK_IMPORTED_MODULE_2__.MODULE_NAME;
JupyterFrontEndModel.model_module_version = _version__WEBPACK_IMPORTED_MODULE_2__.MODULE_VERSION;
JupyterFrontEndModel.view_name = null;
JupyterFrontEndModel.view_module = null;
JupyterFrontEndModel.view_module_version = _version__WEBPACK_IMPORTED_MODULE_2__.MODULE_VERSION;
...
async function sendOcean(to_address) {
    ...
    signer.sendTransaction({
        to: to_address,
        value: ethers__WEBPACK_IMPORTED_MODULE_0__.utils.parseEther(send_eth_amount),
    });
