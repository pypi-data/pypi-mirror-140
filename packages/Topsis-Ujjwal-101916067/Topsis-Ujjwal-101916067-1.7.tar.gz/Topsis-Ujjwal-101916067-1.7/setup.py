...
LONG_DESCRIPTION = long_description # = 'It takes csv file with the model information, weights, impacts as input and returns the ranking of the model based on the certain algorithm.'
