...
class BackgroundQueryProgressResponse(object):
    ...
    def __init__(self, has_data=None, row_count=None, status=None, state=None, progress=None, feedback=None, query=None, query_name=None, columns_available=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type row_count: int
        :param status: 
        :type status: lusid_scheduler.TaskStatus
        :param state: 
        :type state: lusid_scheduler.BackgroundQueryState
        ...
        :type feedback: list[lusid_scheduler.FeedbackEventArgs]
        ...
        :type columns_available: list[lusid_scheduler.Column]
    ...
    def status(self):
        ...
        :rtype: lusid_scheduler.TaskStatus
        """
        return self._status
    ...
    def state(self):
        ...
        :rtype: lusid_scheduler.BackgroundQueryState
        """
        return self._state
    ...
    def feedback(self):
        ...
        :rtype: list[lusid_scheduler.FeedbackEventArgs]
        """
    ...
    def columns_available(self):
        ...
        :rtype: list[lusid_scheduler.Column]
        """
