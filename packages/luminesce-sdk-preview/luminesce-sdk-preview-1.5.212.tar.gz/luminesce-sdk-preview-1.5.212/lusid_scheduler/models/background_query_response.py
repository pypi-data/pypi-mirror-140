...
class BackgroundQueryResponse(object):
    ...
    def __init__(self, execution_id=None, progress=None, cancel=None, fetch_json=None, fetch_json_proper=None, fetch_csv=None, fetch_pipe=None, fetch_excel=None, fetch_sqlite=None, histogram=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param progress: 
        :type progress: lusid_scheduler.Link
        :param cancel: 
        :type cancel: lusid_scheduler.Link
        :param fetch_json: 
        :type fetch_json: lusid_scheduler.Link
        :param fetch_json_proper: 
        :type fetch_json_proper: lusid_scheduler.Link
        :param fetch_csv: 
        :type fetch_csv: lusid_scheduler.Link
        :param fetch_pipe: 
        :type fetch_pipe: lusid_scheduler.Link
        :param fetch_excel: 
        :type fetch_excel: lusid_scheduler.Link
        :param fetch_sqlite: 
        :type fetch_sqlite: lusid_scheduler.Link
        :param histogram: 
        :type histogram: lusid_scheduler.Link
