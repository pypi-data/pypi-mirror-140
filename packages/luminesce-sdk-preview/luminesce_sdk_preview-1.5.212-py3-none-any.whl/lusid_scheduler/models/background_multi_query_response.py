...
class BackgroundMultiQueryResponse(object):
    ...
    def __init__(self, execution_id=None, progress=None, cancel=None, fetch_json=None, fetch_json_proper=None, fetch_csv=None, fetch_pipe=None, fetch_excel=None, fetch_sqlite=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param fetch_json: 
        :type fetch_json: list[lusid_scheduler.Link]
        :param fetch_json_proper: 
        :type fetch_json_proper: list[lusid_scheduler.Link]
        :param fetch_csv: 
        :type fetch_csv: list[lusid_scheduler.Link]
        :param fetch_pipe: 
        :type fetch_pipe: list[lusid_scheduler.Link]
        :param fetch_excel: 
        :type fetch_excel: list[lusid_scheduler.Link]
        :param fetch_sqlite: 
        :type fetch_sqlite: list[lusid_scheduler.Link]
