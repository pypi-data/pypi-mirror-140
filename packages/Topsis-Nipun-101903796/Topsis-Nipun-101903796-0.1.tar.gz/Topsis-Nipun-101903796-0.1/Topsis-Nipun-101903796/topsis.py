...
try:
    # creating logger
    logging.basicConfig(filename="101903796-logger-1.log",
                        format='%(asctime)s %(message)s',
                        filemode='w')
    logger = logging.getLogger('101903796-1')
    ...
    if n > 5 or n < 5:
        logger.error(
            "invalid number of comandline arguments passed,they are greater than or less than 2,")
