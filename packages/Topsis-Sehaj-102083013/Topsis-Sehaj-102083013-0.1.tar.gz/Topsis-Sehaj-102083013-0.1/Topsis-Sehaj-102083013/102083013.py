...
# print("------------------------------------------------------------")
# print("Program Execution Started, Program by: Sehaj Kapoor 102083013 3COE11")
...
def main():
    ...
    if len(sys.argv) != 5:
        ...
        # print("Usage: python 102083013.py 102083013-data.csv \"Weights\" \"Impacts\" 102083013-result-1/2.csv")
        exit(0)
