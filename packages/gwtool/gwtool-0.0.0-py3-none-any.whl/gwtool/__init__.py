...
#   
#  This file is part of the GWtool Python package:
#  Simple tools for working with gravitational waves.
#  See: https://github.com/MarcvdSluys/GWtool
#   
...
The GWtool package can be used under the conditions of the EUPL 1.2 licence.  These pages contain the API
documentation.  For more information on the Python package, licence and source code, see the
`GWtool GitHub page <https://github.com/MarcvdSluys/GWtool>`_.
"""
