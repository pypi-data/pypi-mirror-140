...
class Insight_Definition:
    ...
    def add_table(self, query="", columns=[], pivot_col=[], pivot_type="2"):
        ...
        if(query != "" and columns!=[]):
            self.edit_table(self.components[position]["id"], query, columns, pivot_col, pivot_type)

        return self.components[position]["id"]

    def edit_table(self, table_id, query="", columns=[], pivot_col=[], pivot_type="2"):
