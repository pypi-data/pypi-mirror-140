...
def model_with_data_split(df, label_column, train_start, train_end,  look_back, look_forward, column_set_index = 0, split_n = 30, n_neurons = [128],
                          ...
                          save_model = False, model_path = '', checkpoint_path = '', model_name = 'lstm', enable_optuna = False, epochs_each_try = 10,
...
def linear_model_with_optuna(df, label_column, column_set_index = 0, print_data_shape = True, save_model = False, model_path = '', enable_optuna = True, n_trials = 20, model_name = 'elasticnet', alpha = 0.1, l1 = 0.5):
  df = suite_data.switch_y_column(df, column_name=label_column)
  if column_set_index:
    df.set_index(column_set_index, inplace=True)
