...
class Unum:
    ...
    @typing.overload
    def __lt__(self, other: Unum) -> bool: ...
    @typing.overload
    def __lt__(self, other: float) -> bool: ...
    @typing.overload
    def __le__(self, other: Unum) -> bool: ...
    @typing.overload
    def __le__(self, other: float) -> bool: ...
    @typing.overload
    def __eq__(self, other: Unum) -> bool: ...
    @typing.overload
    def __eq__(self, other: float) -> bool: ...
    @typing.overload
    def __ne__(self, other: Unum) -> bool: ...
    @typing.overload
    def __ne__(self, other: float) -> bool: ...
    @typing.overload
    def __ge__(self, other: Unum) -> bool: ...
    @typing.overload
