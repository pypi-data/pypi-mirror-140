    ...
    while True:
        if queue1.qsize()>0:
            ...
            for map_temp in list_temp:
                ...
                class_name = classfication.detect_image(img_use_temp)
                # class_name = tensorrt_use.landmark_detection(img_use_temp,classfication)
...
def initChushai():
    ...
    # classfication = tensorrt_use.init()
