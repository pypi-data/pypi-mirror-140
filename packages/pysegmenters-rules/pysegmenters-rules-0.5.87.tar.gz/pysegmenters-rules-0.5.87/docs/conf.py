...
import pysegmenters_rules


# -- Project information -----------------------------------------------------

project = "pysegmenters_rules"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pysegmenters_rules.__version__
release = pysegmenters_rules.__version__
...
apidoc_module_dir = os.path.dirname(pysegmenters_rules.__file__)
