    ...
    # Create Testbed
        ...
        # Pass to template 
                ...
                if show_ip_ospf_neighbors_detail_vrf != f"{ hostname } Can't Parse":
                    NXOS_show_ip_ospf_neighbors_detail_vrf_template = env.get_template('NXOS_show_ip_ospf_neighbor_detail_vrf.j2')
                    loop_counter = 0
        # Render Templates
                    for filetype in filetype_loop:
                        parsed_output = NXOS_show_ip_ospf_neighbors_detail_vrf_template.render(to_parse_ip_ospf_neighbor=show_ip_ospf_neighbor_detail_vrf['vrf'],filetype_loop=loop_counter)
                        loop_counter = loop_counter + 1
