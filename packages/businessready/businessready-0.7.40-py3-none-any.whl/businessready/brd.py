...
def NXOS_show_ip_ospf_neighbors_detail(hostname, username, password, ip):
    ...
    # Create Testbed
        ...
        # Render Templates
            for filetype in filetype_loop:
                parsed_output = NXOS_show_ip_ospf_neighbors_detail_template.render(to_parse_ip_ospf_neighbor_detail=show_ip_ospf_neighbors_detail['vrf'],filetype_loop=loop_counter)
                loop_counter = loop_counter + 1
