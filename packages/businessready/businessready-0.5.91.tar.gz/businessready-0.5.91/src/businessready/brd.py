...
def IOS_show_wireless_profile_policy_summary(hostname, username, password, ip):
    ...
    # Create Testbed
        ...
        # Render Templates
            for filetype in filetype_loop:
                parsed_output = IOS_show_wireless_profile_policy_summary_template.render(to_parse_wireless=show_wireless_profile_policy_summary,filetype_loop=loop_counter)
                loop_counter = loop_counter + 1
