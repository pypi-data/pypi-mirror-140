    ...
    # Create Testbed
        ...
        # Pass to template 
            for policy in show_wireless_profile_policy_summary['policy_name']:
                # Show WLAN all to JSON
                try:
                    print(f"show wireless profile policy detailed { policy }")
                    command = f"show wireless profile policy detailed { policy }"
                    print (command)
                    show_wireless_profile_policy_detail = device.parse(f"show wireless profile policy detailed { command }")
                except:
