...
class ParticipantApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_external_participant_id_to_internal_sample_id_0_async = async_wrap(self.get_external_participant_id_to_internal_sample_id_0)
        self.get_external_participant_id_to_internal_sample_id_0_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'HTTPBearer'
                ...
                'operation_id': 'get_external_participant_id_to_internal_sample_id_0',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_external_participant_id_to_internal_sample_id_0(
        self,
        project,
        export_type,
        **kwargs
        ...
        Get csv / tsv export of external_participant_id to internal_sample_id  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_external_participant_id_to_internal_sample_id_0(project, export_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['export_type'] = \
            export_type
        return self.get_external_participant_id_to_internal_sample_id_0_endpoint.call_with_http_info(**kwargs)
