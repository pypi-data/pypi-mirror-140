...
def __signal_orthogonalization_numba(signal_1, signal_2):
    ...
    signal_1 = signal_1.T.copy()
    signal_2 = signal_2.T.copy()

    # Init
    n_samp = signal_1.shape[1]
    n_cha_s1 = signal_1.shape[0]
    n_cha_s2 = signal_1.shape[0]
...
def signal_orthogonalization_gpu(signal_1, signal_2):
    ...
    # VARIABLE INITIALIZE
    # signal_ort = np.empty((len(signal_1),len(signal_2[0]),len(signal_1[0])))
    # signal_ort[:] = np.nan
