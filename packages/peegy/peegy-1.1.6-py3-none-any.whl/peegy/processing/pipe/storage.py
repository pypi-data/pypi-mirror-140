...
class SaveToDatabase(InputOutputProcess):
    def __init__(self,
        ...
        :param include_waveforms: boolean indicating if waveforms from each InputOutputProcess should be saved in the
        database
    ...
    def run(self):
        ...
        for _prefix, _process in zip(self.names_prefixes, self.processes_list):
        ...
        store_data(data_base_path=self.database_path,
