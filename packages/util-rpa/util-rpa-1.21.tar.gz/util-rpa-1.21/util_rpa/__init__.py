...
def upload_file_sftp(filename, destine_path="", credentials={}):
    ...
    Args:
        filename (list, optional): Nombre de archivo(acepta comodines unix * ?) o lista de archivos. Defaults to [].
        destine_path (str, optional): Ruta destino remoto. Defaults to {}.
        recursive (bool, optional): Flag que permite crear directorios recursivamente. Defaults to False.
    """
    import paramiko
...
def makedir_sftp(sftp_path="", credentials={}, recursive = False):
    ...
    Args:
        sftp_path (str, optional): Ruta remoto a crear. Defaults to "".
...
def list_sftp(sftp_path="", credentials={}, attr=False):
    ...
    Args:
        sftp_path (str, optional): Ruta remoto a listar. Defaults to "".
        credentials (dict, optional): Diccionario con credenciales. Defaults to {}.
        attr (bool, optional): Flag que permite borrar el archivo origen. Defaults to False.
...
def remove_sftp(list_files_sftp=[], credentials={}, attr=False):
    ...
    Args:
        list_files_sftp (list, optional): Lista de archivos a borrar. Defaults to "".
        credentials (dict, optional): Diccionario con credenciales. Defaults to {}.
        attr (bool, optional): Flag que permite borrar el archivo origen. Defaults to False.
    """
...
def download_file_sftp(filename="", destine_path="", credentials={}, flag_remove = False):
    ...
    Args:
        filename (str, optional): Nombre de archivo(acepta comodines unix * ?) o lista de archivos. Defaults to "".
        destine_path (str, optional): Prefijo de archivo a descargar. Defaults to "".
        downloadPath (str, optional): Ruta destino remoto. Defaults to "".
        credentials (dict, optional): Diccionario con credenciales. Defaults to {}.
...
def download_by_prefix_sftp(sftpPath="", prefix="", downloadPath="", credentials={}, flag_remove = False):
    ...
    Args:
        sftpPath (str, optional): Path origen del sftp. Defaults to "".
        prefix (str, optional): Prefijo de archivo a descargar. Defaults to "".
        downloadPath (str, optional): Path destino. Defaults to "".
        credentials (dict, optional): Diccionario con credenciales. Defaults to {}.
        flag_remove (bool, optional): Flag que permite borrar el archivo origen. Defaults to False.
    """
...
def move_sftp(filenames={}, credentials={}):
    ...
    Args:
        filenames (dict, optional): Key archivo original y Value archivo destino. Defaults to {}.
        credentials (dict, optional): Diccionario con credenciales del SFTP. Defaults to {}.
...
def replace_string_in_file(filename_in="", filename_out="", dict_words={}):
    ...
    Args:
        filename_in (str, optional): Archivo entrada. Defaults to "".
        filename_out (str, optional): Archivo salida. Defaults to "".
        dict_words (dict, optional): Diccionario de palabras y valores a reemplazar. Defaults to {}.
    """
...
def sqlcmd(file_sql, credentials, file_sql_log, dict_variable = {}, validate_error = True, coding = "65001"):
    ...
    Args:
        file_sql (str): Archivo SQL
        credentials (dict): Diccionario con crediales SQL
        file_sql_log (str): Archivo prefijo para generar archivo log (file_sql_log + ".ahora.db")
        dict_variable (dict, optional): Diccionario de variables a reemplazar. Defaults to {}.
