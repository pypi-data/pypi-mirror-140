...
See:
https://github.com/ToFuProject/datacollection
"""
...
setup(
    ...
    url="https://github.com/ToFuProject/datacollection",
    # Author details
    ...
    keywords="data analysis class container generic interactive collection",
