...
class CustomEntitiesApi(object):
    ...
    def get_custom_entity(self, entity_type, identifier_type, identifier_value, identifier_scope, **kwargs):  # noqa: E501
        ...
        :param entity_type: The type of entity to retrieve. An entityType can be created using the \"CreateCustomEntityDefinition\" endpoint for CustomEntityDefinitions. (required)
        ...
        :type as_at: datetime
        :param effective_at: The effective datetime or cut label at which to get the CustomEntity. Defaults to the current LUSID system datetime if not specified.
