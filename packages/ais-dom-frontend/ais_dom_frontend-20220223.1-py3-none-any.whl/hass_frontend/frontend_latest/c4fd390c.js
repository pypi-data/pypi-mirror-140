/*! For license information please see c4fd390c.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[3643],{96151:(e,t,r)=>{r.d(t,{T:()=>i,y:()=>n});const i=e=>{requestAnimationFrame((()=>setTimeout(e,0)))},n=()=>new Promise((e=>{i(e)}))},22814:(e,t,r)=>{r.d(t,{iI:()=>i,W2:()=>n,TZ:()=>o});location.protocol,location.host;const i=(e,t)=>e.callWS({type:"auth/sign_path",path:t}),n=async(e,t,r,i)=>e.callWS({type:"config/auth_provider/homeassistant/create",user_id:t,username:r,password:i}),o=async(e,t,r)=>e.callWS({type:"config/auth_provider/homeassistant/admin_change_password",user_id:t,password:r})},50538:(e,t,r)=>{r.d(t,{qW:()=>n,kU:()=>o,jU:()=>a,nk:()=>s,Xn:()=>p,Lr:()=>c,i4:()=>l,zj:()=>y,tb:()=>h,B:()=>m,Mw:()=>u});var i=r(22814);const n=2,o="hls",a="web_rtc",s=e=>`/api/camera_proxy_stream/${e.entity_id}?token=${e.attributes.access_token}`,l=async(e,t,r,i)=>{const n=await(async(e,t,r,i,n,...o)=>{let a=i[e];a||(a=i[e]={});const s=a[n];if(s)return s;const l=r(i,n,...o);return a[n]=l,l.then((()=>setTimeout((()=>{a[n]=void 0}),t)),(()=>{a[n]=void 0})),l})("_cameraTmbUrl",9e3,d,e,t);return`${n}&width=${r}&height=${i}`},d=async(e,t)=>{const r=await(0,i.iI)(e,`/api/camera_proxy/${t}`);return e.hassUrl(r.path)},c=async(e,t,r)=>{const i={type:"camera/stream",entity_id:t};r&&(i.format=r);const n=await e.callWS(i);return n.url=e.hassUrl(n.url),n},h=(e,t,r)=>e.callWS({type:"camera/web_rtc_offer",entity_id:t,offer:r}),p=(e,t)=>e.callWS({type:"camera/get_prefs",entity_id:t}),u=(e,t,r)=>e.callWS({type:"camera/update_prefs",entity_id:t,...r}),f="media-source://camera/",m=e=>e.startsWith(f),y=e=>e.substring(f.length)},27849:(e,t,r)=>{r(39841);var i=r(50856);r(28426);class n extends(customElements.get("app-header-layout")){static get template(){return i.d`
    ...
    `}},{kind:"method",key:"willUpdate",value:function(e){if(U(q(h.prototype),"willUpdate",this).call(this,e),!e.has("route"))return;if(""===this.route.path)return void(0,s.c)(`/media-browser/${this._entityId}`,{replace:!0});const[t,...r]=this.route.path.substring(1).split("/");if(t!==this._entityId){if(t!==l.N8&&void 0===this.hass.states[t])return(0,s.c)(`/media-browser/${l.N8}`,{replace:!0}),void(0,A.Ys)(this,{text:this.hass.localize("ui.panel.media-browser.error.player_not_exist",{name:t})});this._entityId=t}this._navigateIds=[{media_content_type:void 0,media_content_id:void 0},...r.map((e=>{const[t,r]=decodeURIComponent(e).split(",");return{media_content_type:t,media_content_id:r}}))],this._currentItem=void 0}},{kind:"method",key:"_goBack",value:function(){(0,s.c)(H(this._entityId,this._navigateIds.slice(0,-1)))}},{kind:"method",key:"_mediaBrowsed",value:function(e){e.detail.ids!==this._navigateIds?(0,s.c)(H(this._entityId,e.detail.ids),{replace:e.detail.replace}):this._currentItem=e.detail.current}},{kind:"method",key:"_mediaPicked",value:async function(e){const t=e.detail.item;if(this._entityId!==l.N8){this._player.showResolvingNewMediaPicked();try{await this.hass.callService("media_player","play_media",{entity_id:this._entityId,media_content_id:t.media_content_id,media_content_type:t.media_content_type})}catch(e){this._player.hideResolvingNewMediaPicked()}return}if((0,T.B)(t.media_content_id))return void(0,a.B)(this,"hass-more-info",{entityId:(0,T.zj)(t.media_content_id)});this._player.showResolvingNewMediaPicked();const i=await(0,d.uy)(this.hass,t.media_content_id);var n,o;i.mime_type.startsWith("audio/")?this._player.playItem(t,i):(n=this,o={sourceUrl:i.url,sourceType:i.mime_type,title:t.title,can_play:t.can_play},(0,a.B)(n,"show-dialog",{dialogTag:"hui-dialog-web-browser-play-media",dialogImport:()=>Promise.all([r.e(85084),r.e(53822),r.e(3212)]).then(r.bind(r,3212)),dialogParams:o}),this._player.hideResolvingNewMediaPicked())}},{kind:"method",key:"_playerPicked",value:function(e){const t=e.detail.entityId;t!==this._entityId&&(0,s.c)(H(t,this._navigateIds))}},{kind:"method",key:"_refreshMedia",value:function(){this._browser.refresh()}},{kind:"get",static:!0,key:"styles",value:function(){return[c.Qx,i.iv`
      ...
      `]}}]}}),i.oi)}}]);
//# sourceMappingURL=c4fd390c.js.map