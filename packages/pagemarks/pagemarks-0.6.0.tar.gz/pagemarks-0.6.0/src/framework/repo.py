...
from framework.globals import BOOKMARK_ID_LEN, DEFAULT_COLL_NAME
from framework.util import normalize_tags, PagemarksError, read_json_with_comments
...
class Collection(object):
    ...
    def get_htmlname(self) -> str:
        return ('index' if self.is_default() else self.name) + '.html'
