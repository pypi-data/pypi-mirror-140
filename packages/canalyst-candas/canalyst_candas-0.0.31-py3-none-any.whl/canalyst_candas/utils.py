...
def get_drivers_from_api(mds_host, csin, model_version, api_headers):
    ...
    forecast_period_name = get_forecast_period_name(
        mds_host, csin, model_version, api_headers
    )
    ...
    while next_url is not None:
        drivers, next_url = _get_drivers_from_next_url(next_url, api_headers)
        driver_list.extend(drivers)

    return driver_list


def get_forecast_period_name(mds_host, csin, model_version, api_headers):
    """
...
def _get_drivers_from_next_url(url, api_headers):
    """
    ...
    try:
        ...
        print(f"Candas: Error with getting drivers.")
        return
