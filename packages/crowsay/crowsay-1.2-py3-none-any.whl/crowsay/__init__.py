...
─────────────────────────────────────────────────────────────────────
        ...
        if update:
            ...
            system('cat .version')
            system(' wget -q https://raw.githubusercontent.com/Simplehacker1Community/crowsay/simplehacker/.ping &> /div/null')
            update = 'truelove'
            file1 = open(".ping", "r")
            readfile = file1.read()
            if update in readfile:
                ...
                system("cd ..")
                system('rm -rf crowsay')
                system('git clone htpps://github.com/simplehacker1communty/crowsay')
                system('cd crowsay')
