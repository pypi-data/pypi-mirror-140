...
"""
# Necessary keys =======================================================================================================
KEYS = {'sps_attempts': int, 'test_convex_initial': bool, 'algo_displace': int, 'i_cycle_after_displace': bool,
        'disp2_superpos_modenr_low': int, 'disp2_superpos_modenr_high': int, 'disp2_eigalgo': int,
        ...
        'algo_escape_again': int, 'i_start_after_converge': bool, 'i_write_initial_eigenvecs': bool}
