            ...
            for index2, esckey in enumerate(current_esc_keys):
                ...
                try:
                    ...
                    if self.strategies_stages['CONV'] == 1:
                        ...
                        df_mmf = pd.read_csv(self.parent_directory / Path(folder_search) / 'info_mfef.dat', sep=r'\s+')
                    else:
                        raise ValueError('CONV strategy is not coded.')
