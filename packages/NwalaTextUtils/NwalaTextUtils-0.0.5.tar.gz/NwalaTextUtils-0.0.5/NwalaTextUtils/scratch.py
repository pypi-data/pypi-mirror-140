...
def test_get_links():
	from textutils import getLinks
	uri = 'http://www.heraldtimesonline.com/'
	#uri = 'https://www.hoosiertimes.com/herald_times_online/entertainment/'
	
	links = getLinks(uri, fromMainTextFlag=False, rmFragments=False)
	for l in links:
		print(l)
