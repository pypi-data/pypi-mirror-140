...
class LegacyTranslationEnum:
    ...
    ACTIONS_FORGET_CARD = (1, 27)
    ACTIONS_HELP = (1, 28)
    ACTIONS_IMPORT = (1, 29)
    ACTIONS_MANAGE = (1, 30)
    ACTIONS_NAME = (1, 31)
    ACTIONS_NEW = (1, 32)
    ACTIONS_NEW_NAME = (1, 33)
    ACTIONS_OPTIONS = (1, 34)
    ACTIONS_OPTIONS_FOR = (1, 35)
    ACTIONS_PREVIEW = (1, 36)
    ACTIONS_PREVIOUS_CARD_INFO = (1, 37)
    ...
    DECK_CONFIG_NEW_GATHER_PRIORITY_TOOLTIP = (11, 50)
    ...
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (11, 77)
    DECK_CONFIG_SKIP_QUESTION_WHEN_REPLAYING = (11, 78)
    DECK_CONFIG_SORT_ORDER_ASCENDING_EASE = (11, 79)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (11, 80)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_HIGHEST_POSITION = (11, 81)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_LOWEST_POSITION = (11, 82)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (11, 83)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (11, 84)
    DECK_CONFIG_SORT_ORDER_DESCENDING_EASE = (11, 85)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (11, 86)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (11, 87)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (11, 88)
    DECK_CONFIG_SORT_ORDER_GATHER = (11, 89)
    DECK_CONFIG_SORT_ORDER_HIGHEST_POSITION = (11, 90)
    DECK_CONFIG_SORT_ORDER_LOWEST_POSITION = (11, 91)
    DECK_CONFIG_SORT_ORDER_RANDOM = (11, 92)
    DECK_CONFIG_SORT_ORDER_RANDOM_NOTE_THEN_TEMPLATE = (11, 93)
    DECK_CONFIG_SORT_ORDER_TEMPLATE_THEN_GATHER = (11, 94)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (11, 95)
    DECK_CONFIG_TIMER_TITLE = (11, 96)
    DECK_CONFIG_TITLE = (11, 97)
    ...
    EDITING_TAGS = (13, 45)
    EDITING_TEXT_COLOR = (13, 46)
    EDITING_TEXT_HIGHLIGHT_COLOR = (13, 47)
    EDITING_TO_MAKE_A_CLOZE_DELETION_ON = (13, 48)
    EDITING_TOGGLE_HTML_EDITOR = (13, 49)
    EDITING_TOGGLE_STICKY = (13, 50)
    EDITING_TOGGLE_VISUAL_EDITOR = (13, 51)
    EDITING_UNDERLINE_TEXT = (13, 52)
    ...
    ERRORS_FILTERED_DECK_REQUIRED = (15, 4)
    ERRORS_FILTERED_PARENT_DECK = (15, 5)
    ERRORS_INVALID_INPUT_DETAILS = (15, 6)
    ERRORS_INVALID_INPUT_EMPTY = (15, 7)
    ERRORS_MULTIPLE_NOTETYPES_SELECTED = (15, 8)
    ERRORS_OPTION_NOT_SET = (15, 9)
    ERRORS_PARSE_NUMBER_FAIL = (15, 10)
    ERRORS_PLEASE_CHECK_DATABASE = (15, 11)
    ERRORS_STANDARD_POPUP = (15, 12)
    ERRORS_UNABLE_OPEN_COLLECTION = (15, 13)
    ERRORS_WINDOWS_TTS_RUNTIME_ERROR = (15, 14)
    ...
    PREFERENCES_KEEP = (25, 13)
    PREFERENCES_LEARN_AHEAD_LIMIT = (25, 14)
    PREFERENCES_LEGACY_TIMEZONE_HANDLING = (25, 15)
    PREFERENCES_MINS = (25, 16)
    PREFERENCES_NETWORK = (25, 17)
    PREFERENCES_NEXT_DAY_STARTS_AT = (25, 18)
    PREFERENCES_NIGHT_MODE = (25, 19)
    ...
    PREFERENCES_WHEN_ADDING_DEFAULT_TO_CURRENT_DECK = (25, 49)
    PREFERENCES_YOU_CAN_RESTORE_BACKUPS_VIA_FILESWITCH = (25, 50)
...
class GeneratedTranslations:
    ...
    def actions_options_for(self, val: FluentVariable) -> str:
        r''' Options for {$val} '''
        return self._translate(1, 35, {"val": val})
    ...
    def actions_with_ellipsis(self, action: str) -> str:
        r''' {$action}... '''
        return self._translate(1, 61, {"action": action})
...
Debug info: '''
    ...
    def errors_invalid_input_details(self, details: str) -> str:
        ...
        return self._translate(15, 6, {"details": details})
    ...
    def errors_option_not_set(self, option: str) -> str:
        r''' '{$option}' not set '''
        return self._translate(15, 9, {"option": option})
