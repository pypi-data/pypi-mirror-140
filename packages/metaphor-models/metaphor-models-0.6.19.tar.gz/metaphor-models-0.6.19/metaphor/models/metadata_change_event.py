...
class DbtMetric:
    ...
    tags: Optional[List[str]] = None
    test_grains: Optional[List[str]] = None
    ...
    def from_dict(obj: Any) -> 'DbtMetric':
        ...
        tags = from_union([lambda x: from_list(from_str, x), from_none], obj.get("tags"))
        test_grains = from_union([lambda x: from_list(from_str, x), from_none], obj.get("testGrains"))
        timestamp = from_union([from_str, from_none], obj.get("timestamp"))
        type = from_union([from_str, from_none], obj.get("type"))
        url = from_union([from_str, from_none], obj.get("url"))
        return DbtMetric(id, aspect_type, created_at, description, dimensions, entity_id, filters, dbt_metric_id, label, latest, model, package_name, source_datasets, source_models, sql, tags, test_grains, timestamp, type, url)
    ...
    def to_dict(self) -> dict:
        ...
        result["tags"] = from_union([lambda x: from_list(from_str, x), from_none], self.tags)
        result["testGrains"] = from_union([lambda x: from_list(from_str, x), from_none], self.test_grains)
