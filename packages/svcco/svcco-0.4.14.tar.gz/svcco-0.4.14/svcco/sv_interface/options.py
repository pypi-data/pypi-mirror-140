...
class file_options:
    ...
    def __init__(self,inflow=1,gui=True):
        """
        ...
        self.simulation_parameters(inflow=inflow)
    ...
    def set_directories(self,outdir=None):
        ...
        directory_constructor['main_folder'] = outdir+'/CCO_DATA'
        number = len(glob.glob(directory_constructor['main_folder']+'/CCO_*'))
        directory_constructor['data_folder'] = directory_constructor['main_folder']+'/simulation_data{}'.format(number)
        directory_constructor['mesh_complete_folder'] = directory_constructor['data_folder']+'/mesh-complete'
        directory_constructor['mesh_surfaces_folder'] = directory_constructor['mesh_complete_folder']+'/mesh-surfaces'
        directory_constructor['centerline_folder'] = directory_constructor['data_folder']+'/centerlines'
        directory_constructor['postprocessing_folder'] = directory_constructor['data_folder']+'/post'
        self.directory_constructor = directory_constructor
        self.number = number
        self.filename = directory_constructor['main_folder']+'/CCO_{}.py'.format(number)
