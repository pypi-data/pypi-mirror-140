...
#
#     # 对训练集进行Bunch化操作：
#     wordbag_path = "E:/SVMmodel/train_word_bag/train_wordbag.dat"  # Bunch存储路径
#     seg_path = "E:/SVMmodel/train_tokens/"  # 分词后分类语料库路径
#     stopword_path = "E:/SVMmodel/train_word_bag/hit_stopwords.txt"
