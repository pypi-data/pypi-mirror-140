            ...
            >
                ...
                <DIV sx={{
                    ...
                    <DIV sx={{padding: '12px'}}>
                        ...
                        <DIV sx={{width: 'fit-content', margin: '6px auto'}}>
                            You can purchase additional storage and egress if you need more than what we offer for free. Charges will accrue as you use resources, so you don’t have to decide up front. 
                        </DIV>
