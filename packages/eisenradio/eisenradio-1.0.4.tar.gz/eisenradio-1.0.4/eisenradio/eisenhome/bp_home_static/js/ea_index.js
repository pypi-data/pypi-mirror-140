...
$(document).ready(function () {
    ...
    var analyser_random = Math.random();
    if (analyser_random < 0.5) {
        analyser_random = 0
    } else {
        analyser_random = 1
    }
    ...
    */
    ...
    function visualise_audio(var_canvas) {
        ...
        try {
            if (analyser_random === 0) { animate(); }
            if (analyser_random === 1) { draw(); }
        } catch (error) {
            console.error(error);
        }
...
function cookie_toggle_show_visuals() {
    ...
    req.done(function (data) {
        ...
        if (show_visuals !== 'show_visuals') {
            ...
            canvas_master.style.display = "block";
            cookie_set_show_visuals();
        }
        if (show_visuals === 'show_visuals') {
            analyzer_badge.textContent = "show";
            canvas_master.style.display = "none";
...
function setColor(val) {
    ...
    req.done(function (data) {
        ...
        if (color === 'black') {
            ...
            bodyStyles.setProperty('--canvas_master', 'rgba(26,26,26,0.7)');
        ...
        if (color === 'white') {
            ...
            bodyStyles.setProperty('--canvas_master', 'rgba(240, 240, 240, 0.7)');
