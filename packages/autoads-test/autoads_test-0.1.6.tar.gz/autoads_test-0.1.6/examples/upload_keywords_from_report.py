...
from autoads.gads import (add_negative_keywords, get_existing_keywords,get_search_term_report,get_all_ads,create_ad,
                        create_keyword,_handle_googleads_exception,create_adgroup, get_all_shared_sets)
...
df_search_term_report = df_search_term_report[df_search_term_report['campaign_status'].isin(['ENABLED']) &
                                              df_search_term_report['adgroup_status'].isin(['ENABLED'])]
...
if len(df_search_term_report_negative) != 0:
    ...
    if len(df_search_term_report_negative) != 0:
        ...
        if answer == 'y' or answer == 'Y':
            ...
            info_dict['shared_set_id'].extend(len(keyword_ids1)*[shared_set_id])
