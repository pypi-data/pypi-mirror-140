...
class StatsWindowFunctionAccessor(BaseWindowFunctionAccessor):
    """StatsWnidowFunctionAccessor contains a collection of statistical functions that act on one or more column
    ...
    def empirical_cdf(self, x: BaseColumnExpression, value: Union[int, float]) -> WindowAggregate:
        ...
        The empirical CDF is the cumulative distribution function of a sample. See
        https://en.wikipedia.org/wiki/Empirical_distribution_function
        This function returns the value of the empirical CDF at the supplied value.
    ...
    def stdev(self, x: BaseColumnExpression) -> WindowAggregate:
        ...
        Returns:
            WindowAggregate: a WindowAggregate isntance representing the result of this calculation.
        """
