...
class CfnServer(
    ...
    def __init__(
        ...
        *,
        ...
        :param protocol_details: Protocol settings that are configured for your server. .. epigraph:: Only valid in the ``UpdateServer`` API.
    ...
    class EndpointDetailsProperty:
        def __init__(
            ...
            *,
            ...
            :param address_allocation_ids: A list of address allocation IDs that are required to attach an Elastic IP address to your server's endpoint. This is only valid in the ``UpdateServer`` API. .. epigraph:: This property can only be set when ``EndpointType`` is set to ``VPC`` .
            :param security_group_ids: A list of security groups IDs that are available to attach to your server's endpoint. .. epigraph:: This property can only be set when ``EndpointType`` is set to ``VPC`` . *Maximum number of security groups* : 5
