...
class TrainingJobResult:
  _tjName: str
  _tjVersion: str
  _tjResultId: Union[str, int, None]
  _results: Union[List[ResultDescription], None] = None
...
class TrainingJobDetails:
  ...
  def get_result(self, result_id: Union[str, int, None]):
...
class TrainingJobs:
  _mbMain: ModelbitCore
  _trainingJobs: List[RuntimeInfo] = []
