...
class Runtime:
  ...
  def _getFuncProps(self):
    ...
    if not callable(self._deployFunc):
      ...
      # TODO: switch to inspect.getfullargspec(func) for args and types
      props.argNames = list(self._deployFunc.__code__.co_varnames[:self._deployFunc.__code__.co_argcount] or [])
  ...
  def getFuncSource(self):
    ...
    return inspect.getsource(self._deployFunc)
