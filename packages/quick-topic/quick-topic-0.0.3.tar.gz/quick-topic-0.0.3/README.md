...
# step 1: data file
meta_csv_file = "../datasets/list_company_news_meta.csv"
text_root = r"text_data_processed2"
...
divide_by_year(
    ...
    raw_text_folder=r"carbon2-research\information_extraction2\datasets\g20_news_processed",
...
show_year_month_trends_with_fulltext(
    ...
    list_topics=list_topics,
    label_names=label_names,
    save_result_path="results/leader_trends2.csv",
    minimum_year=2010,
...
trends_file1="../test_topic_trends/results/leader_trends.csv"
trends_file2="../test_topic_trends/results/leader_trends2.csv"
selected_field = '政府'
estimate_topic_trends_correlation(
    trend_file1=trends_file1,
    trend_file2=trends_file2,
...
Example 8: Estimate the correlation among trends pairs
```python
from quick_topic.topic_trends_correlation.topic_trends_correlation_matrix import *
list_compare = [
        ["leader", "industry"],
        ["leader", "company"],
        ["leader", "weibo"],
...
labels = ['经济', '能源', '公民', '政府']
estimate_trends_corrleation_matrix(
