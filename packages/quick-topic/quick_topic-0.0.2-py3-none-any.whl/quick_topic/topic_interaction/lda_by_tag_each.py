...
def LDA(field,list_doc,weights_path,list_keywods_path,stopwords_path):
...
def lda_by_tag_each(category_path,root_path,weights_path,list_keywords_path,stopwords_path):
    ...
    for country in dict_keywords.keys():
        list_doc = []
        print(country)
        ...
        if len(list_doc) >= 20:
            LDA(country, list_doc,weights_path,list_keywords_path,stopwords_path)
        print()
