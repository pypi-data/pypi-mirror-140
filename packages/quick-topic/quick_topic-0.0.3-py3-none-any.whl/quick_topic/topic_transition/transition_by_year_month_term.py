...
def create_keyword_distribution(root_path, keyword,save_figure=False,list_range=None,start_year=2000,end_year=2021,output_figure_folder="",min_total_num=10,maximum_rate_if_meet_min_num=0.8,font_size=16,style="seaborn-deep"):
    ...
    show_scatter(label_name, x, y,save_figure=save_figure,list_range=list_range,output_figure_folder=output_figure_folder)
...
def show_scatter(title,x,y,save_figure=False,list_range=None,output_figure_folder=""):
