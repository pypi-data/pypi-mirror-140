...
def LDA(field,list_doc,weights_path,list_keywods_path,stopwords_path,num_topics=6):
...
def lda_by_tag_each(list_category,root_path,weights_path,list_keywords_path,stopwords_path,minimum_num_doc=20,num_topics=6):
    ...
    for country in list_category:
        ...
        if len(list_doc) >= minimum_num_doc:
            ...
            LDA(country, list_doc,weights_path,list_keywords_path,stopwords_path,num_topics)
        print()
