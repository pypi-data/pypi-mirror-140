...
def makeaxissub(axs,objects,cats,mindiff,
    ...
    ticks = {}
    for ax in axs.flat:
        minx,maxx,xlocs,xvals,xtrans = makeaxis_sub(ax,'x',objects,xlabel,xticks,xsubticks,xrotation,xalign,xminmax,xzero,xfontsize,xlog,xlogbase,xlog0,dynamic,categories = cats['x'],mindiff = mindiff['x'])
        miny,maxy,ylocs,yvals,ytrans = makeaxis_sub(ax,'y',objects,ylabel,yticks,ysubticks,yrotation,yalign,yminmax,yzero,yfontsize,ylog,ylogbase,ylog0,dynamic,categories = cats['y'],mindiff = mindiff['y'])
        trans['x'] = xtrans
        trans['y'] = ytrans
        minmax['x'] = (minx,maxx)
        minmax['y'] = (miny,maxy)
