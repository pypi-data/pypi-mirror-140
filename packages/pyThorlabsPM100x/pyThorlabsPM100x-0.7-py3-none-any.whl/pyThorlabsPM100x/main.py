...
class interface():
    ...
    plot_window : Qt.QWidget
        Window containing the plot object
    plot_object : PlotObject
        It contains the pyqtgraph plot
...
### GUI Events Functions
    ...
    def click_button_connect_disconnect(self):
        ...
        if(self.instrument.connected == False): # We attempt connection   
            ...
            self.connect_device(device_full_name)
    ...
    def click_box_PowerRangeAuto(self, state):
        if state == QtCore.Qt.Checked:
            ...
            status_bool = False
        self.set_power_range_auto(status_bool)

    def click_button_set_zero_powermeter(self):
        self.set_zero_powermeter()

    def press_enter_wavelength(self):
        self.set_wavelength(self.edit_Wavelength.text())
        
    def click_button_change_power_range(self,direction):
        self.change_power_range(direction)
    ...
    def press_enter_refresh_time(self):
        self.set_refresh_time(self.edit_RefreshTime.text())
...
### Functions to talk with low-level driver
    ...
    def connect_device(self,device_full_name):
        ...
        if(ID==1):  #If connection was successful
            ...
            self.power_units = device.power_units
