...
class Message(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"author_id",b"author_id",u"body",b"body",u"pinned",b"pinned",u"resolved",b"resolved",u"thread_id",b"thread_id"]) -> None: ...
...
class Thread(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"for_canonical_id",b"for_canonical_id",u"for_entity_type",b"for_entity_type",u"message_count",b"message_count",u"messages",b"messages",u"pinned",b"pinned",u"resolved",b"resolved",u"title",b"title"]) -> None: ...
