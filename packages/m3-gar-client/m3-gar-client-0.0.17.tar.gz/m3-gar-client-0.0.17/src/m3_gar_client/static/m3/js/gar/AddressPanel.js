...
Ext.m3.gar.AddressFields = Ext.extend(Ext.Component, {
    ...
    updateHouse: function(record) {
        ...
        if (record.get('houseNumber')) {
            ...
            this.isSteadSelected = false;
        } else if (record.get('steadNumber')) {
            this.houseNumberField.setValue(record.get('steadNumber'));
            this.flatNumberField.setReadOnly(true);
            this.isSteadSelected = true;
        }
        else {
    ...
    getFullAddress: function() {
        ...
        if (!this.isPlaceEmpty()) {
            ...
            if (this.hasHouseField() && !this.isHouseEmpty()) {
                if (this.isSteadSelected) {
                    addressParts.push(
                    'земельный участок ' + this.houseNumberField.getValue()
                    );
                }
                else {
                    addressParts.push(
