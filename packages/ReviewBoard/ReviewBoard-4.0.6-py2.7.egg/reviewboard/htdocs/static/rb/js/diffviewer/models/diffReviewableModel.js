...
RB.DiffReviewable = RB.AbstractReviewable.extend({
  ...
  getRenderedDiff: function getRenderedDiff(callbacks, context) {
    ...
    var url = this._buildRenderedDiffURL();
  ...
  getRenderedDiffFragment: function getRenderedDiffFragment(options, callbacks, context) {
    ...
    this._fetchFragment({
      url: "".concat(this._buildRenderedDiffURL(), "chunk/").concat(options.chunkIndex, "/"),
      data: {
  ...
  _buildRenderedDiffURL: function _buildRenderedDiffURL() {
    ...
    var revisionStr = this.get('revision');

    if (interdiffRevision) {
      revisionStr += '-' + interdiffRevision;
    }

    return this.get('reviewRequest').get('reviewURL') + 'diff/' + revisionStr + '/fragment/' + this.get('fileDiffID') + (interFileDiffID ? '-' + interFileDiffID : '') + '/' + (baseFileDiffID ? '?base-filediff-id=' + baseFileDiffID : '');
  }
});
