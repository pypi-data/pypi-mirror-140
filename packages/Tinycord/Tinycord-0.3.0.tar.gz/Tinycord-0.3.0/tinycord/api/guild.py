...
class GuildAPI:
    ...
    async def guild_create_channel(self, guild_id: str, reason: str = None , **data):
        ...
        **data : `typing.Dict`
        ...
        overwrites = data.pop('permission_overwrites', None)
        
        if overwrites:
            data['permission_overwrites'] = [overwrite.form_dict() for overwrite in overwrites]
    ...
    async def get_webhooks(self, guild_id: str):
        """
        Get a guild webhooks.
        ...
        guild_id : `str`
            The id of the guild.
        """
        res =  await self.client.http.request(Router(f'/guilds/{guild_id}/webhooks', 'GET'))
