...
class ChannelAPI:
    ...
    async def channel_edit(self, channel_id: str, reason: str = None, **data) -> dict:
        ...
        **data : `typing.Dict`
        ...
        if 'permission_overwrites' in data:
            data['permission_overwrites'].extend(
                [permission.form_dict() for permission in data['before_permission_overwrites']])

        del data['before_permission_overwrites']
    ...
    async def channel_messages_create(self, channel_id: str, **data) -> "Message":
        ...
        guild_id = data['other'].get('guild_id', None)
        del data['other']
        ...
        for embed in data.get('embeds', []):
            if isinstance(embed, Embed):
                data['embeds'][data['embeds'].index(embed)] = embed.form_dict()
    ...
    async def channel_messages_reactions_get(self, channel_id: str, message_id: str, emoji: "Emoji"):
        ...
        return await self.client.http.request(Router(f'/channels/{channel_id}/messages/{message_id}/reactions/{emoji}', 'GET'))
    ...
    async def channel_messages_reactions_create_me(self, channel_id: str, message_id: str, emoji: "Emoji"):
        ...
        return await self.client.http.request(Router(f'/channels/{channel_id}/messages/{message_id}/reactions/{emoji}/@me', 'PUT'))
    ...
    async def channel_messages_reactions_delete_me(self, channel_id: str, message_id: str, emoji: "Emoji", reason: str = None):
        ...
        return await self.client.http.request(Router(f'/channels/{channel_id}/messages/{message_id}/reactions/{emoji}/@me', 'DELETE'),
            headers=_reason(reason))
    ...
    async def channel_messages_reactions_delete(self, channel_id: str, message_id: str, emoji: "Emoji", user_id: str, reason: str = None):
        ...
        return await self.client.http.request(Router(f'/channels/{channel_id}/messages/{message_id}/reactions/{emoji}/{user_id}', 'DELETE'),
            headers=_reason(reason))
    ...
    async def channel_messages_reactions_delete_all(self, channel_id: str, message_id: str, emoji: "Emoji", reason: str = None):
        ...
        return await self.client.http.request(Router(f'/channels/{channel_id}/messages/{message_id}/reactions/{emoji}', 'DELETE'),
            headers=_reason(reason))
    ...
    async def get_webhooks(self, channel_id: str):
        ...
        webhooks : `list`
            The webhooks.
        """
        res =  await self.client.http.request(Router(f'/channels/{channel_id}/webhooks', 'GET'))

        return [Webhook(self.client, **webhook) for webhook in res]

    async def follow_news_channel(self, channel_id: str):
        """
        ...
        res = await self.client.http.request(
            Router(f'/channels/{channel_id}/followers', 'POST'))
        
        return {
            "channel_id": Snowflake(res['channel_id']),
            "guild_id": Snowflake(res['guild_id'])
        }