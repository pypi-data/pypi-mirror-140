...
class BaseChannel(Hashable):
    ...
    def __init__(self, client: "Client", guild_id: Snowflake , **data) -> None:
        ...
        self.permission_overwrites: typing.List["Overwrite"] = [
            Overwrite.read(**overwrite) for overwrite in data.get('permission_overwrites')]
        """The permission overwrites of the channel."""
    ...
    async def edit(self, reason: str = None, **kwargs) -> None:
        ...
        """
        kwargs.update({'before_permission_overwrites': self.permission_overwrites})
