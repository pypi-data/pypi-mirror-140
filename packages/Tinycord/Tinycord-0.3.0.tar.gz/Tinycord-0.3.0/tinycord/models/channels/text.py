...
class TextChannel(BaseChannel,Hashable):
    ...
    async def trigger_typing(self) -> None:
        """
            This is used to trigger typing in the channel.
        """

        return await self.client.api.channel_start_typing(self.id)

    def get_messages(self, limit: int = 50) -> typing.Union[None, typing.List["Message"]]:
        """
            This is used to get the messages of the channel.
        ...
        return [ message for message in self.client.messages.values() if message.channel_id == self.id ][:limit]