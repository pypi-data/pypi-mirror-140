...
class Guild(Hashable):
    ...
    def __init__(self, client: "Client", **data) -> None:
        ...
        self.stickers: typing.Dict[str, "Sticker"] = {
            sticker['id'] : ( sticker.update({'guild_id': self.id}) and Sticker(client, **sticker)) for sticker in data.get('stickers')}
        ...
        self.guild_scheduled_events: typing.Dict[str, "ScheduledEvent"] = {
            event['id'] : ( event.update({'guild_id': self.id}) and ScheduledEvent(client, **event)  ) for event in data.get('guild_scheduled_events')}
        ...
        self.voice_server: typing.Union[None, typing.Dict[str, str]] = None
        """The voice server of the guild."""
    ...
    def shard(self) -> typing.Union["Gateway", None]:
        ...
        return self.client.shards[self.hash % len(self.client.shards)]

    @property
    def icon_url(self) -> typing.Union[None, str]:
    ...
    @property
    def splash_url(self) -> typing.Union[None, str]:
        """
        The splash URL of the guild.

        """

        return (
            f'https://cdn.discordapp.com/splashes/{self.id}/{self.splash}.jpg' if not self.splash.startswith('a_') else 
                f'https://cdn.discordapp.com/splashes/{self.id}/{self.splash}.gif')

    @property
    def banner_url(self) -> typing.Union[None, str]:
        """
        The banner URL of the guild.
