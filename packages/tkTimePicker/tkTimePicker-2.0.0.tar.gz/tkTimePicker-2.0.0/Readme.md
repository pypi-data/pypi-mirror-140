...
> you can also use mouse wheel to change the time with modern timepicker, 
> you can also make use of keypress to change time if you hover over the timepicker.
