def makevideo(cover, song, artist, toptext, output):
    ...
    with resources.open_binary('megacrazyscripts', 'Roboto-Black.ttf') as font1:
        toptext = [toptext, 300, font1, 250]
    with resources.open_binary('megacrazyscripts', 'Roboto-Bold.ttf') as font2:
        song = [song, 3240, font2, 279]
    with resources.open_binary('megacrazyscripts', 'Roboto-Light.ttf') as font3:
