...
class TrigramPerplexityComputer(PerplexityComputer):
    def __init__(self, bigrams_model_path):
        ...
        try:
            ...
            file.write(requests.get("https://gitlab.citius.usc.es/pyplexity/pyplexity.pages.citius.usc.es/-/raw/master/bigrams_bnc.st").content)
            data = retrieve(file)
