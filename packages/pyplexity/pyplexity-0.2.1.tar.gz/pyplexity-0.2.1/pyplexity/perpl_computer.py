...
class perplexity_computer:
    ...
    def from_str(cls, perpl_model: str):
        try:
            ...
            data = retrieve(file)
        if len(data) > 2:
            return trigram_perplexity_computer(data)
        else:
            return bigram_perplexity_computer(data)


class bigram_perplexity_computer(perplexity_computer):
...
class trigram_perplexity_computer(perplexity_computer):
    def __init__(self, data):
...
if __name__ == '__main__':
    ...
    computer = bigram_perplexity_computer(bigrams_model_path)
