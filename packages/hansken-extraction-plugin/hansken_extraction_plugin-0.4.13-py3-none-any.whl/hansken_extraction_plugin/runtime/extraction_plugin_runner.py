...
def _process(project_context: ProjectContext, plugin: BaseExtractionPlugin, trace: Trace, data_type: str):
    data_context = DataContext(data_size=trace.get(f'data.{data_type}.size'), data_type=data_type)
