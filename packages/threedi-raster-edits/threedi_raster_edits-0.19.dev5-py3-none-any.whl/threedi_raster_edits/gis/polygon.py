...
# Local imports
from .geometry import Geometry, dissolve
...
def centerline(geometry: Polygon, resolution: int, intersection: bool):
    if not HAS_SCIPY:
    ...
    cleaned = MultiLineString(dissolved).clean(intersection)
    return cleaned
