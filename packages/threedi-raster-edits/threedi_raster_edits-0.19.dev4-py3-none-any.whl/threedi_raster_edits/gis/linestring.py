...
class LineString(Geometry):
    ...
    def points_on_line(
        ...
        return points_on_line(
            self.points, interval, custom_interval, start, end, vertices, geometry,
        )

    def perpendicular_lines(
        self, distance, perpendicular_length, start=True, end=True, vertices=False,
    ):
...
def perpendicular_lines(
    linestring, line_dist=10, perp_dist=10, start=True, end=True, vertices=False,
):
