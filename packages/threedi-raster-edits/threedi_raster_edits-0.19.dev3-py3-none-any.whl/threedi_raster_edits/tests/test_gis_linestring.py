...
def test_start_point():
    ...
    line_geom = LineString(line)
    assert line_geom.start_point.point == (117565.43122004971, 459721.3204805324,)


def test_end_point():
    """tests if start point has original value"""
    line_geom = LineString(line)
    assert line_geom.end_point.point == (117486.66500118251, 459702.01357949915,)
...
def test_reversed():
    ...
    assert reverse.start_point.point == (117486.66500118251, 459702.01357949915,)
