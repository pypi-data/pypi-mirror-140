...
if __name__ == '__main__':
    ...
    data=HoldingExtractor_DB()._load_portfolio_weight(jjdm='P04365',date_list=['20150630','20150930'])
    ...
    name_list=['新方程域秀智享5号','新方程望正精英鹏辉','新方程泰暘臻选1期']
    code_list=['P11954','S38012','SJQ505']
    date_list=pd.read_excel(r"E:\私募主观\私募主观可用持仓列表3.xlsx")
    for i in range(len(code_list)):
        code=code_list[i]
        name=name_list[i]
        date_list_temp=date_list[date_list['code']==code].astype(str)
